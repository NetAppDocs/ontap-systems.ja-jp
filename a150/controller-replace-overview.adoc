...
---
= AFF A150システムでコントローラーを交換するための要件を確認します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A150システムのコントローラーを交換する前に、交換を正常に完了するために必要な要件を満たしていることを確認してください。すべてのドライブシェルフが正常に動作していること、正常なコントローラが障害のあるコントローラをテイクオーバーできること、およびお使いのONTAPのバージョンに適した交換手順を選択していることを確認してください。
