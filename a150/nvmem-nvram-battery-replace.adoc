...
---
= AFF A150 システムの NVMEM バッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A150システムのNVMEMバッテリーは、充電が低下し始めたり故障したりした場合に交換してください。このバッテリーは停電時に重要なシステムデータを保持します。交換手順は、コントローラーモジュールの取り外し、バッテリーの交換、およびコントローラーモジュールの再取り付けで構成されます。
