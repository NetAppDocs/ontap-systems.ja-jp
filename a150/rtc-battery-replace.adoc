...
summary: コントローラモジュール内のリアルタイムクロックバッテリを交換することで、正確な時刻同期に依存するシステムのサービスやアプリケーションが引き続き機能するようになります。 
---
= AFF A150システムのリアルタイムクロックバッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A150システムのリアルタイム時計（RTC）バッテリーを交換して、正確な時刻同期に依存するサービスやアプリケーションが引き続き機能することを確認してください。
