...
summary: AFF A1Kシステムに新しいブートメディアデバイスを設置したら、リカバリイメージをUSBドライブからブートし、パートナーノードから設定をリストアできます。 
---
= 手動ブートリカバリプロセスを使用して AFF A1K システムのリカバリイメージを起動します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A1Kシステムに新しいブート メディア デバイスをインストールした後、USB ドライブからリカバリ イメージを手動で起動して、パートナー ノードから構成を復元できます。
