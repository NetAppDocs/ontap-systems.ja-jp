...
summary: AFF A1K ストレージシステムの障害コントローラーをシャットダウンして、手動ブート回復プロセス中のデータ損失を防ぎ、システムの安定性を維持します。 
---
...
[role="lead"]
AFF A1K ストレージシステムの障害コントローラーをシャットダウンして、手動ブート回復プロセス中のデータ損失を防ぎ、システムの安定性を維持します。
