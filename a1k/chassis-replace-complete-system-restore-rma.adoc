...
[role="lead"]
コントローラーを再起動し、システムの状態を確認し、AFF A1K システムのシャーシ交換の最終ステップを完了するために、障害のある部品を NetApp に返送してください。
...
コントローラーを再起動した後、ONTAP を起動し、コントローラーをギブバックして、システムの状態を確認してください。
