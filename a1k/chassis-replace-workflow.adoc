...
summary: 交換要件を確認し、コントローラをシャットダウンし、シャーシを交換し、システムの動作を確認して、 AFF A1Kストレージ システムのシャーシの交換を開始します。 
---
= シャーシ交換ワークフロー - AFF A1K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
交換要件を確認し、コントローラをシャットダウンし、シャーシを交換し、システムの動作を確認して、 AFF A1Kストレージ システムのシャーシの交換を開始します。
