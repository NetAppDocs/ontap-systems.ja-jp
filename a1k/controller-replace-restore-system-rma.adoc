...
summary: AFF A1Kシステムのコントローラ交換を完了するには、NetApp Storage Encryptionの設定をリストアし、論理インターフェイスがホームポートにレポートしていることを確認してクラスタのヘルスチェックを実行し、障害が発生したパーツをNetAppに返却します。 
---
= AFF A1K システムのコントローラーの交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
