...
summary: AFF A1Kストレージシステムのコントローラをシャットダウンしてデータ損失を防止し、コントローラの交換時にシステムの安定性を確保します。 
---
= AFF A1K システムで障害のあるコントローラーを交換前にシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A1Kストレージシステムのコントローラをシャットダウンしてデータ損失を防止し、コントローラの交換時にシステムの安定性を確保します。
