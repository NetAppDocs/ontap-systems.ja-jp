...
---
= AFF A1K システムをシャットダウンせずに I/O モジュールをホットスワップする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
I/O モジュールをホット スワップするには、ストレージ システムが ONTAP 9.18.1 GA 以降を実行していることを確認してください。次に、ストレージ システムと I/O モジュールを準備し、故障したモジュールをホット スワップして、交換用モジュールをオンラインにし、通常の動作を復元してから、故障したモジュールを NetApp に返却してください。
