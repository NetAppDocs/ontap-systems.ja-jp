...
summary: AFF A20、AFF A30、またはAFF A50システムの交換用ブートメディアで暗号化をリストアして、データを継続的に保護します。交換プロセスには、キーの可用性の確認、暗号化設定の再適用、およびデータへのセキュアなアクセスの確認が含まれます。 
---
= ブートメディア（AFF A20、AFF A30、AFF A50）での暗号化のリストア
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A20、AFF A30、またはAFF A50システムの交換用ブートメディアで暗号化をリストアして、データを継続的に保護します。交換プロセスには、キーの可用性の確認、暗号化設定の再適用、およびデータへのセキュアなアクセスの確認が含まれます。
