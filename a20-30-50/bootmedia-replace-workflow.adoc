...
---
= AFF A20、AFF A30、またはAFF A50システムの手動ブートリカバリプロセスを使用したブートメディア交換ワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
システムで ONTAP 9.17.1 以降が実行されている場合は、link:bootmedia-replace-workflow-bmr.html["自動ブート回復手順"]を使用してください。
...
[role="quick-margin-para"]
ブート メディアを交換する必要がある場合は、コントローラーをシャットダウンします。
