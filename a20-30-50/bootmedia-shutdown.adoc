...
summary: 手動ブートメディア復旧プロセス中のデータ損失を防ぎ、システムの安定性を維持するために、AFF A20、AFF A30、または AFF A50 ストレージシステムのコントローラをシャットダウンします。 
---
...
[role="lead"]
手動ブートメディア復旧プロセス中のデータ損失を防ぎ、システムの安定性を維持するために、AFF A20、AFF A30、または AFF A50 ストレージシステムのコントローラをシャットダウンします。
