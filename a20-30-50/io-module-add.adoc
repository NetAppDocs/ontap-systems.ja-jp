...
---
= I/OモジュールをAFF A20、AFF A30、またはAFF A50システムに追加してネットワーク接続を強化します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
追加プロセスには、1 つのコントローラのシャットダウン、新しい I/O モジュールの追加、コントローラの再起動、もう一方のコントローラのシャットダウン、新しい I/O モジュールの追加、コントローラの再起動が含まれます。
