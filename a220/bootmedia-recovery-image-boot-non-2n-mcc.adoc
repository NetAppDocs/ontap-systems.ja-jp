...
summary: USB ドライブからONTAPイメージを起動し、ファイル システムを復元し、環境変数を確認する必要があります。AFF A220システムは、手動のブート メディア リカバリ手順のみをサポートします。 
---
= AFF A220 システムでリカバリイメージをブートする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A220システムのUSBドライブからONTAPリカバリイメージをブートし、手動ブートリカバリプロセスを使用してブートメディアを復元します。
