...
[role="lead"]
NetApp Storage Encryption の設定を復元し（必要な場合）、新しいコントローラのライセンスをインストールし、障害ドライブを NetApp に返却することで、AFF A220 システムのコントローラの交換を完了します。NetApp
