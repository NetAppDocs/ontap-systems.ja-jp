...
summary: このガイドでは、 AFF A250 システムをインストールするための詳細な手順を説明します。 
---
= 詳細ガイド - AFF A250
:icons: font
:imagesdir: ../media/
...
[role="lead"]
このガイドでは、 AFF A250 システムをインストールするための詳細な手順を説明します。
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=beec3966-0a01-473c-a5de-ac68017fbf29["2 ノードスイッチレスクラスタのケーブル接続"]
...
. アニメーションやステップバイステップの手順に従って、コントローラとスイッチをケーブルで接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bf6759dc-4cbf-488e-982e-ac68017fbef8["スイッチクラスタのケーブル接続"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=3f92e625-a19c-4d10-9028-ac68017fbf57["コントローラを 1 台の NS224 にケーブル接続する"]
