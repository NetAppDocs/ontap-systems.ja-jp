...
.手順
. アニメーションを使用します（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=beec3966-0a01-473c-a5de-ac68017fbf29["2 ノードスイッチレスクラスタをケーブル接続"^]）またはステップバイステップの手順に従って、コントローラとスイッチをケーブルで接続します。
+
[cols="10,90"]
|===
| ステップ | 各コントローラでを実行します 
...
.手順
. アニメーションを使用します（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bf6759dc-4cbf-488e-982e-ac68017fbef8["スイッチクラスタのケーブル接続"^]）またはステップバイステップの手順に従って、コントローラとスイッチをケーブルで接続します。
+
[cols="10,90"]
|===
| ステップ | 各コントローラでを実行します 
...
. アニメーションを使用します（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=3f92e625-a19c-4d10-9028-ac68017fbf57["コントローラを 1 台の NS224 にケーブル接続する"^]）またはステップバイステップの手順に従って、コントローラモジュールを 1 台のシェルフにケーブル接続します。
+
[cols="10,90"]
|===
| ステップ | 各コントローラモジュールでを実行します 
