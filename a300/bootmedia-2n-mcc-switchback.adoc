...
summary: 2ノードのMetroCluster構成でブートメディアの交換が完了したら、MetroClusterスイッチバック処理を実行して、構成を通常の動作状態に戻します。AFF A300システムは、手動によるブートメディアリカバリ手順のみをサポートしています。 
---
= AFF A300システムの2ノードMetroCluster構成でアグリゲートをスイッチバックします
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
