...
summary: ストレージ システムのハードウェア構成に応じて、さまざまな手順を使用して障害のあるコントローラをシャットダウンしたり、引き継いだりすることができます。AFF A300システムは、手動のブート メディア リカバリ手順のみをサポートします。 
---
= 手動ブートリカバリプロセス中に AFF A300 システムの障害コントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
構成に適した手順を使用して、障害のあるコントローラーをシャットダウンするか、引き継ぎます。AFF A300システムは、手動のブート メディア リカバリ手順のみをサポートします。自動ブート メディア リカバリはサポートされていません。
