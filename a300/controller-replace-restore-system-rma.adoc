...
summary: AFF A300 システムを完全な動作状態に戻すには、必要に応じてNetApp Storage Encryption構成をリストアし、新しいコントローラのライセンスをインストールして、障害が発生した部品をNetAppに返却します。 
---
= AFF A300 システムのコントローラー交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NetApp Storage Encryption の設定を復元し（必要な場合）、新しいコントローラのライセンスをインストールし、障害ドライブを NetApp に返却することで、AFF A300 システムのコントローラの交換を完了します。NetApp
