...
summary: AFF A300 システムの障害のあるコントローラーを交換する前に、お使いの構成に適した手順に従ってシャットダウンしてください。 
---
= AFF A300システムで障害のあるコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A300 システムの障害のあるコントローラーを交換する前に、お使いの構成に適した手順に従ってシャットダウンしてください。
