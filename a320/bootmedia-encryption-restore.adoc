...
summary: 環境変数を確認した後、オンボード キー マネージャー、 NetAppストレージ暗号化、またはNetAppボリューム暗号化が有効になっているシステムに固有の手順を完了する必要があります。AFF A320システムは、手動のブート メディア リカバリ手順のみをサポートします。自動ブート メディア リカバリはサポートされていません。 
---
= AFF A320 システムのブートメディアの暗号化を復元する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
交換用ブート メディアで暗号化を復元します。AFF A320システムは、手動のブート メディア リカバリ手順のみをサポートします。自動ブート メディア リカバリはサポートされていません。
