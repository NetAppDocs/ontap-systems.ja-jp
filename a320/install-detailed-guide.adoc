...
X66250-30 （ 112-00331 ）、 30m
 a| 
image:../media/oie_cable_etherned_mpo.png["イーサネットケーブル - MPO"]
 a| 
イーサネットケーブル（注文内容による）
...
+
image::../media/drw_a320_weight_label.png[システムリフト重量に関する注意事項]
...
+
image::../media/drw_a320_tnsc_network_cabling_composite_animated_gif.png[2ノオトスイツチレスクラスタノケエフルセツソク]
...
** e0a から e0a
** e0dとe0d image:../media/drw_a320_tnsc_cluster_ha_connection_step1a.png["2ノードスイッチレスクラスタでクラスタHA接続を接続"]
...
** e0gとe0h image:../media/drw_a320_onboard_data_connection_step2.png["オンボードデータネットワーク接続を接続"]




 a| 
image:../media/oie_legend_icon_3_dr.png["手順 3"]
 a| 
イーサネット接続または FC 接続に NIC カードを使用している場合は、 NIC カードを適切なスイッチに接続します。

image::../media/drw_a320_nic_connections_step3.png[2ノードスイッチレスクラスタでNICを接続]



 a| 
image:../media/oie_legend_icon_4_lp.png["ステップ4"]
 a| 
RJ45 ケーブルを使用して、 e0M ポートを管理ネットワークスイッチに接続します。

image:../media/drw_a320_management_port_connection_step4.png["管理ポートの接続"]
...
. 図またはステップバイステップの手順に従って、コントローラとスイッチをケーブルで接続します。
+
image::../media/drw_a320_switched_network_cabling_composite_animated_GIF.png[スイッチクラスタのケーブル接続]
...
** 両方のコントローラのe0dをクラスタ/ HAスイッチに接続 image:../media/drw_a320_switched_cluster_ha_connection_step1b.png["スイッチクラスタクラスタ- HA接続"]
...
** e0gとe0h image:../media/drw_a320_onboard_data_connection_step2.png["スイッチクラスタのオンボードネットワーク接続"]
...
image::../media/drw_a320_nic_connections_step3.png[スイッチクラスタのネットワーク接続]
...
image:../media/drw_a320_management_port_connection_step4.png["スイッチクラスタ管理ネットワーク接続"]
...
+
image::../media/drw_a320_single_shelf_connections_animated_gif.png[1ツノドライブシェルフノケエフルセツソク]
...
| ステップ | 各コントローラモジュールでを実行します 
 ...
 a| 
image:../media/oie_legend_icon_1_mb.png["番号1"]
 a| 
コントローラAをシェルフにケーブル接続します。 image:../media/drw_a320_storage_cabling_controller_a_single_shelf.png["コントローラ A をシェルフにケーブル接続します"]



 a| 
image:../media/oie_legend_icon_2_lo.png["番号2"]
 a| 
コントローラBをシェルフにケーブル接続します。 image:../media/drw_a320_storage_cabling_controller_b_single_shelf.png["コントローラBを1台のシェルフに接続"]
...
+
image::../media/drw_a320_2_shevles_cabling_animated_gif.png[ケーブル2台のシェルフのアニメーション]
...
image:../media/oie_legend_icon_1_mb.png["番号1"]
 a| 
コントローラAをシェルフにケーブル接続します。 image:../media/drw_a320_2_shelves_cabling_controller_a.png["2台のシェルフをコントローラAにケーブル接続"]
...
image:../media/oie_legend_icon_2_lo.png["番号2"]
 a| 
コントローラBをシェルフにケーブル接続します。 image:../media/drw_a320_2_shelves_cabling_controller_b.png["コントローラbへのテオシェルセスのケーブル接続"]
...
+
image::../media/drw_a320_laptop_to_switch_and_controller.png[ラップトップを管理サブネットスイッチにケーブル接続します。]
