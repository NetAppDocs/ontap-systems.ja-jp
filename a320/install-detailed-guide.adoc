...
---
= 詳細な手順を使用して AFF A320 ストレージシステムをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A320ストレージシステムを、ラックへの設置やケーブル接続から初期システム起動まで、詳細なステップバイステップの手順に従ってインストールします。
...
image::../media/drw_a320_nic_connections_step3.png[2ノードスイッチレスクラスタでNICを接続]
 ...
 a| 
image:../media/icon_square_4_red.png["ステップ4"]
 a| 
