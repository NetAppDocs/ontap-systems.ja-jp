...
summary: AFF A320 コントローラモジュールのリアルタイムクロックバッテリを交換して、正確な時刻同期に依存するサービスやアプリケーションが引き続き機能するようにします。 
---
= AFF A320 システムのリアルタイムクロックバッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A320システムのリアルタイムクロック（RTC）バッテリーを交換して、正確な時刻同期に依存するサービスやアプリケーションが引き続き正常に機能することを確認してください。
...
+
image::../media/drw_a320_controller_cable_unplug_animated_gif.png[ケーブルマネジメントデバイスを取り外します。]
...
image::../media/drw_a320_rtc_batt_replace_animated_gif.png[RTC バッテリを交換します]
