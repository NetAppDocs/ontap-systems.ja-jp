...
summary: AFF A400 ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータ損失を防ぎ、システムの安定性を確保します。 
---
...
[role="lead"]
AFF A400 ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア回復プロセス中のデータ損失を防ぎ、システムの安定性を維持します。
