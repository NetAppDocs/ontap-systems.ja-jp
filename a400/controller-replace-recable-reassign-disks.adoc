...
summary: ストレージリソースの制御を交換用コントローラに戻すと、AFF A400 システムは通常動作を再開できます。 
---
= AFF A400システムでシステムのケーブルを再配線し、ディスクを再割り当てする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージリソースの制御を交換用コントローラに戻すと、AFF A400 システムは通常動作を再開できます。
