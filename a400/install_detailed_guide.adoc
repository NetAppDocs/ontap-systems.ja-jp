...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=48552ddf-0925-4f88-8e93-ab1b00666489["2 ノードスイッチレスクラスタのケーブル接続"]

+
image::../media/drw_A400_TNSC-network-cabling.png[DRW A400 TNSC ネットワークケーブル配線]
...
. アニメーションや図を使用して、コントローラとスイッチをケーブルで接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=8fefba75-f395-4cf2-ba3c-ab1b00665870["スイッチクラスタのケーブル接続"]

+
image::../media/drw_a400_switched_network_cabling.png[DRW 400: スイッチドネットワークケーブル配線]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=48d68897-c91d-47dc-b4b0-ab1b0066808a["NS224 ドライブシェルフへのコントローラのケーブル接続"]

+
image::../media/drw_a400_one_ns224_shelves.png[DRW 4001 ns224 シェルフ]
...
.手順
. 次のアニメーションまたは図を使用して、 2 台のドライブシェルフにコントローラをケーブル接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=5501c7bf-8b74-49e8-8067-ab1b00668804["2 台の NS224 ドライブシェルフへのコントローラのケーブル接続"]

+
image::../media/drw_a400_two_ns224_shelves.png[DRW 4002 台の ns224 シェルフ]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=cbb0280e-708d-4365-92b6-ab1b006677ef["SAS ドライブシェルフへのコントローラのケーブル接続"]

+
image::../media/drw_a400_three_ds224c_shelves.png[DRW 4003 ds224c シェルフ]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=50cdf200-ede1-45a9-b4b5-ab1b006698d7["コントローラの電源をオンにします"]
