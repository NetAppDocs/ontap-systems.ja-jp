...
---
= AFF A400 システムの NVDIMM バッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A400 システムの NVDIMM バッテリーの充電量が低下し始めたり、障害が発生したりした場合は、バッテリーを交換してください。交換手順は、コントローラーモジュールの取り外し、バッテリーの交換、およびコントローラーモジュールの再取り付けで構成されます。
...
image::../media/drw_A400_nvdimm-batt_IEOPS-1004.svg[NVDIMMバッテリを交換してください]
