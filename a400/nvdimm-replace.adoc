...
summary: システムでフラッシュの寿命がほぼ終了したこと、または特定された NVDIMM が正常でないことが登録された場合は、AFF A400 コントローラモジュールの NVDIMM を交換してください。障害のある NVDIMM を交換しないと、システムパニックが発生する可能性があります。 
---
= AFF A400システムのNVDIMMを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A400システムがフラッシュメモリの寿命がほぼ尽きている、またはNVDIMMが正常でないことを検知した場合は、システムのNVDIMMを交換してください。交換を怠ると、システムパニックが発生する可能性があります。
