...
---
= AFF A400システムのPCIeカードまたはメザニンカードを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A400システムのPCIeカードまたはメザニンカードが故障した場合、またはアップグレードが必要な場合は、カードを交換してください。交換作業には、ケーブルとSFPまたはQSFPモジュールの取り外し、カードの交換、そしてケーブルの再接続が含まれます。
