...
summary: AFF A70またはAFF A90システムのブートメディアが破損した場合は、USBドライブからリカバリイメージをブートし、パートナーノードから設定をリストアして、環境変数を確認できます。 
---
...
[role="lead"]
AFF A70またはAFF A90システムのブートメディアが破損した場合は、USBドライブからリカバリイメージをブートし、パートナーノードから設定をリストアして、環境変数を確認できます。
