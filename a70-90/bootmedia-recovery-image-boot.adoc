...
summary: AFF A70またはAFF A90システムのブートメディアが破損した場合は、USBドライブからリカバリイメージをブートし、パートナーノードから設定をリストアできます。 
---
...
[role="lead"]
AFF A70またはAFF A90システムのブートメディアが破損した場合は、USBドライブからリカバリイメージをブートし、パートナーノードから設定をリストアできます。
