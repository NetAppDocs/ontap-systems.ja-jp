...
summary: AFF A70またはAFF A90ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータ損失を防ぎ、システムの安定性を確保してください。 
---
...
[role="lead"]
自動ブートメディアリカバリプロセス中にデータ損失を防ぎ、システムの安定性を維持するために、AFF A70またはAFF A90ストレージシステムのコントローラをシャットダウンしてください。
