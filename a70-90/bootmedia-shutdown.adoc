...
summary: ブートメディアの交換が必要になったときは、AFF A70またはAFF A90ストレージシステムのコントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。 
---
= コントローラをシャットダウンしてブートメディアを交換- AFF A70 and AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ブートメディアの交換が必要になったときは、AFF A70またはAFF A90ストレージシステムのコントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。
