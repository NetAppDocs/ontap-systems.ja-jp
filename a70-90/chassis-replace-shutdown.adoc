...
summary: AFF A70またはAFF A90ストレージシステムのコントローラをシャットダウンして、データ損失を防ぎ、シャーシの交換時にシステムの安定性を確保します。 
---
= シャーシを交換するために AFF A70 または AFF A90 コントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A70またはAFF A90ストレージシステムのコントローラをシャットダウンして、データ損失を防ぎ、シャーシの交換時にシステムの安定性を確保します。
...
.次の手順
コントローラーをシャットダウンした後、link:chassis-replace-move-hardware.html["シャーシを交換する"] 。
