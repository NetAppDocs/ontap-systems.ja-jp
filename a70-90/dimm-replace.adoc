...
---
= AFF A70またはAFF A90システムのDIMMを交換してメモリエラーを修正する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.作業を開始する前に
* システム内の他のすべてのコンポーネントが正常に機能していることを確認してください。そうでない場合は、テクニカルサポートにお問い合わせください。
...
DIMMを交換するには、コントローラー内部にあるDIMMの位置を確認し、指定された手順に従ってください。
