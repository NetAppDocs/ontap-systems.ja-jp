...
summary: ブートメディアの交換が完了したら、MetroClusterスイッチバック操作により、構成を通常の動作状態に戻します。AFF A700システムは、手動によるブートメディア復旧手順のみをサポートしています。 
---
= AFF A700システムの2ノードMetroCluster構成でアグリゲートをスイッチバックする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
