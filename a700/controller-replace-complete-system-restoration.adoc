...
summary: AFF A700 システムを完全に動作させるには、ストレージを再配線し、必要に応じて NetApp Storage Encryption の設定を復元し、新しいコントローラーのライセンスをインストールします。 
---
= AFF A700システムのコントローラーの交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A700システムのコントローラー交換を完了するには、ストレージの再配線、NetAppストレージ暗号化設定の復元（必要な場合）、および新しいコントローラーのライセンスのインストールを行います。
