...
summary: 障害ノードをシャットダウンするには、ノードのステータスを確認し、必要に応じて正常なノードが障害ノードのストレージからデータを引き続き提供できるようにノードをテイクオーバーする必要があります。 
---
= AFF A700システムの交換前に障害のあるコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A700 システムの障害のあるコントローラーをシャットダウンするには、交換前に、お使いの構成に適した手順に従ってください。
