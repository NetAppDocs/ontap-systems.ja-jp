...
summary: システムで修正可能なエラー訂正コードまたは修正不可能なECCエラーの数が増加している場合は、AFF A700コントローラモジュールのDIMMを交換してください。故障したDIMMを交換しないと、システムパニックが発生する可能性があります。 
---
= AFF A700 システムの DIMM を交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージシステムで過剰な訂正可能なECCエラーまたは訂正不可能なECCエラーが検出された場合は、AFF A700システムのDIMMを交換してください。
