...
summary: AFF A700sシステムを完全な動作状態に戻すには、必要に応じてNetApp Storage Encryptionの設定をリストアし、新しいコントローラのライセンスをインストールして、障害が発生した部品をNetAppに返却します。 
---
= AFF A700s システムのコントローラーの交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NetApp Storage Encryption の設定を復元し（必要な場合）、新しいコントローラのライセンスをインストールし、障害ドライブを NetApp に返却することで、AFF A700s システムのコントローラの交換を完了します。NetApp
