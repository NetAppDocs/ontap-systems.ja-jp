...
summary: シャーシを交換するには、コントローラーの電源を切る必要があります。 
---
= シャーシを交換するためにAFF A800コントローラをシャットダウンします
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、 AFF A800ストレージ システムのコントローラをシャットダウンします。
