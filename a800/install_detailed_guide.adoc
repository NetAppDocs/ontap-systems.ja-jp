...
.手順
. アニメーションまたは表に示す手順を使用して、コントローラとスイッチのケーブル接続を完了します。ビデオ：edc42447 -f721 -4cbe -b080 -ab0c0123a139 [panopto、title=" 2ノードスイッチレスクラスタのケーブル接続"]
+
[cols="10,90"]
|===
...
.手順
. アニメーションまたは表に示す手順を使用して、コントローラとスイッチのケーブル接続を完了します。ビデオ：49e48140-4c5a-4395-a7d7-aab0c0123a10e [panopto、title="スイッチクラスタのケーブル接続"]
+
[cols="10,90"]
|===
| ステップ | 各コントローラモジュールでを実行します 
