...
---
= AFF A800 システムの NVDIMM バッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A800システムのNVバッテリーが充電不足になり始めたり故障したりした場合は、停電時に重要なシステムデータを保持するために交換してください。交換手順は、コントローラーモジュールの取り外し、バッテリーの交換、およびコントローラーモジュールの再取り付けで構成されます。
