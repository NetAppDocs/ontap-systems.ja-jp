...
summary: 手動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、AFF A900ストレージシステムのコントローラーをシャットダウンします。 
---
= 手動ブートリカバリプロセス中に AFF A900 システムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
手動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、AFF A900ストレージシステムのコントローラーをシャットダウンします。
...
.ほとんどの構成
--
NVEまたはNSEタスクを完了したら、コントローラのシャットダウンを完了する必要があります。
