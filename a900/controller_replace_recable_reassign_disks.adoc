...
summary: ストレージとネットワーク構成の配線をやり直して、交換手順を続行します。 
---
= AFF A900システムのケーブルを再配線し、ディスクを再割り当てする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージとネットワーク構成を再接続し、NetApp Storage Encryption を復元して、AFF A900 システムを完全稼働状態に戻します。
