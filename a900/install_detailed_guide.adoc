...
image::../media/drw_a900_controller_in _chassis_ID_IEOPS-856.svg[一般的なクラスタ構成]
...
+
image::../media/drw_a900_oie_change_ns224_shelf_ID_IEOPS-836.svg[DRW a900 OIEでは'ns224シェルフID IEOPS 836が変更されます]
