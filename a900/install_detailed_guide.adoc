...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=7a55b98a-e8b8-41d5-821f-ac5b0032ead0["アニメーション -- 2 ノードスイッチレスクラスタのケーブル接続"^]
...
|===
. ストレージをケーブル接続するには、を参照してください <<Step 4: Cable controllers to drive shelves>>。
...
. アニメーションや図を使用して、コントローラとスイッチをケーブルで接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6381b3f1-4ce5-4805-bd0a-ac5b0032f51d["アニメーション -- スイッチクラスタのケーブル接続"^]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6520eb01-87b3-4520-9109-ac5b0032ea4e["アニメーション -- 1 台の NS224 シェルフのケーブル接続"^]
...
|===
.. システムのセットアップを完了するには、を参照してください <<Step 5: Complete system setup and configuration>>。
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=34098e39-73ad-45de-9af7-ac5b0032ea9a["アニメーション -- 2 台の NS224 シェルフのケーブル接続"^]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=95a29da1-faa3-4ceb-8a0b-ac7600675aa6["アニメーション -- SAS または NVMe ドライブシェルフ ID の設定"^]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=a905e56e-c995-4704-9673-adfa0005a891["アニメーション -- コントローラの電源を入れます"^]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d61f983e-f911-4b76-8b3a-ab1b0066909b["アニメーション -- ラップトップを管理スイッチに接続します"^]
...
. 両方のノードの電源スイッチをオンにします。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bb04eb23-aa0c-4821-a87d-ab2300477f8b["アニメーション -- コントローラの電源を入れます"^]
