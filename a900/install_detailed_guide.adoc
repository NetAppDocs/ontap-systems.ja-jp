...
X66100-5 （ 112-00544 ）、 5m
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[GbE銅線SFP]
 a| 
...
X6562-R6 （ 112-00196 ）、 5m
 a| 
image::../media/oie_cable_rj45.svg[RJ-45ケーブルコネクタ]
 a| 
管理ネットワークとイーサネットデータ
...
該当なし
 a| 
image::../media/oie_cable_micro_usb.svg[マイクロUSBコネクタ]
 a| 
...
該当なし
 a| 
image::../media/oie_cable_power.svg[電源ケーブルコネクタ]
 a| 
システムの電源をオンにします
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 Gbコネクタ]
...
image::../media/oie_cable100_gbe_qsfp28.svg[100GbEケーブルコネクタ]
...
image:../media/oie_cable_power.svg["電源ケーブル"]
...
image:../media/oie_cable100_gbe_qsfp28.svg["100GbEケーブル"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["吹き出しアイコン2"]
 a| 
コントローラ管理（レンチマーク）ポートをケーブル接続します。
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[DRW a900fas9500電源アイコンIEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[ケーブルプルタブの方向]
...
| ステップ | 各コントローラでを実行します 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[番号1]
 a| 
** コントローラ A のポート e2a を、シェルフの NSM A のポート e0a に接続します。
** コントローラ A のポート e10b をシェルフの NSM B のポート e0b に接続します。


image::../media/oie_cable100_gbe_qsfp28.svg[100GbE QSFPコネクタ]
...
100GbE ケーブル
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[番号2]
 a| 
