...
+
image:drw_9500_lifting_icon.svg["重量挙げ警告ラベル"]

. ケーブルマネジメントデバイスを取り付けます（図を参照）。
+
image:drw_9500_cable_management_arms.svg["ケーブル管理ARMの取り付け"]
...
image:drw_a900_controller_in _chassis_ID_IEOPS-856.svg["一般的なクラスタ構成"]
