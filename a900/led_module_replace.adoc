...
---
= AFF A900 システムの LED USB モジュールを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A900 システムの LED USB モジュールを交換して、コンソールポートへの接続とシステムステータスを復元します。交換作業には工具は不要で、サービスの中断もありません。
...
+
image::../media/drw_a900_remove_replace_LED_mod.svg[LED USBモジュールの取り外し]
