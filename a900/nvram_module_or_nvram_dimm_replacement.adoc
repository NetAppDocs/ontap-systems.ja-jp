...
summary: NVRAM モジュールは、 NVRAM11 と DIMM 、および NVRAM モジュールあたり最大 2 つの NVMe SSD Flash Cache モジュールで構成されます。 
---
= AFF A900システムのNVRAMモジュールまたはNVRAM DIMMを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A900システムのNVRAMモジュールまたはNVRAM DIMMは、モジュールに障害が発生したり、DIMMに不具合が生じたりした場合に交換してください。交換の手順では、シャーシからNVRAMモジュールを取り外し、故障したコンポーネントを交換してから、モジュールを再取り付けします。
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[NVRAMモジュールの取り外し]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[NVRAMモジュールの内容の取り外し]
