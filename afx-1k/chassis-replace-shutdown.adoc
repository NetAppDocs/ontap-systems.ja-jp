...
summary: シャーシを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、AFX 1K ストレージ システムのコントローラーをシャットダウンします。 
---
= シャーシを交換するために AFX 1K コントローラーをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、AFX 1K ストレージ システムのコントローラーをシャットダウンします。
