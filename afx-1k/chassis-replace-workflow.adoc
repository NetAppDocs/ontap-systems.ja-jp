...
summary: 交換要件を確認し、コントローラーをシャットダウンし、シャーシを交換し、システムの動作を確認して、AFX 1K ストレージ システムのシャーシの交換を開始します。 
---
= シャーシ交換ワークフロー - AFX 1K
:allow-uri-read: 
:icons: font
...
[role="lead"]
交換要件を確認し、コントローラーをシャットダウンし、シャーシを交換し、システムの動作を確認して、AFX 1K ストレージ システムのシャーシの交換を開始します。
