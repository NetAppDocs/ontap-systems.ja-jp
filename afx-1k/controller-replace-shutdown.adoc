...
summary: データ損失を防ぎ、コントローラー交換時のシステム安定性を確保するため、AFX 1K ストレージシステム内の障害のあるコントローラーをシャットダウンしてください。 
---
...
[role="lead"]
データ損失を防ぎ、コントローラー交換時のシステム安定性を確保するため、AFX 1K ストレージシステム内の障害のあるコントローラーをシャットダウンしてください。
