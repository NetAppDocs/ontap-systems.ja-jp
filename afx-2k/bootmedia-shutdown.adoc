...
summary: ブートメディアを交換する際は、データ損失を防ぎ、システムの安定性を確保するために、AFX 2Kストレージシステム内の故障したコントローラーをシャットダウンしてください。 
---
= 自動ブートリカバリプロセス中に、AFX 2Kストレージシステムのコントローラーをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ブートメディアを交換する際は、データ損失を防ぎ、システムの安定性を確保するために、AFX 2Kストレージシステム内の故障したコントローラーをシャットダウンしてください。
