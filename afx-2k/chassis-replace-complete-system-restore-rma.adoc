...
summary: コントローラーを再起動し、システムの健全性を確認し、故障した部品を NetApp に返送して、AFX 2K シャーシ交換手順の最終ステップを完了してください。 
---
= AFX 2Kストレージシステムのシャーシ交換を完了します。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
コントローラーを再起動し、システムの健全性を確認し、故障した部品を NetApp に返送して、AFX 2K シャーシ交換手順の最終ステップを完了してください。
