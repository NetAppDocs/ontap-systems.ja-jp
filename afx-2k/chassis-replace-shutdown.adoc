...
summary: シャーシを交換する際は、データ損失を防ぎ、システムの安定性を確保するために、AFX 2Kストレージシステムのコントローラーをシャットダウンしてください。 
---
= シャーシを交換するには、AFX 2K コントローラーをシャットダウンしてください。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシを交換する際は、データ損失を防ぎ、システムの安定性を確保するために、AFX 2Kストレージシステムのコントローラーをシャットダウンしてください。
