...
summary: お使いの AFX 2K ストレージシステムのコントローラーに不具合が生じた場合は、コントローラーをシャットダウンしてください。メンテナンスや部品交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラーを安全にシャットダウンすることが非常に重要です。 
---
= 障害のあるコントローラーをシャットダウンする - AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
