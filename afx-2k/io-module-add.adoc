...
summary: AFX 2KストレージシステムにI/Oモジュールを追加することで、ネットワーク接続性を強化し、システムのデータトラフィック処理能力を拡張できます。 
---
= AFX 2KシステムにI/Oモジュールを追加して、ネットワーク接続性を強化します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFX 2KストレージシステムにI/Oモジュールを追加することで、ネットワーク接続性を強化し、システムのデータトラフィック処理能力を拡張できます。

AFX 2Kストレージシステムには、空きスロットがある場合、またはすべてのスロットが埋まっている場合に、I/Oモジュールを追加できます。
...
.作業を開始する前に
*  https://hwu.netapp.com["NetApp Hardware Universe の略"^]を確認して、新しいI/OモジュールがストレージシステムおよびONTAPバージョンと互換性があることを確認してください。
