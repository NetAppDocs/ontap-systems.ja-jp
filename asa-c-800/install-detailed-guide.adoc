...
summary: このセクションでは、ASA C800システムの設置手順について詳しく説明します。 
---
= 詳細な手順- ASA C800
:allow-uri-read: 
:icons: font
...
[role="lead"]
このセクションでは、ASA C800システムの設置手順について詳しく説明します。



== 手順 1 ：設置の準備

ASA C800システムをインストールするには、アカウントを作成してシステムを登録する必要があります。また、システムに応じた適切な数とタイプのケーブルを準備し、特定のネットワーク情報を収集する必要があります。
...
. 必要に応じてレールキットを取り付けます。
+
https://docs.netapp.com/us-en/ontap-systems/platform-supplemental/superrail-install.html["丸穴 4 ポストラックへの SuperRail の取り付け"^]
...
+
image::../media/drw_asac800_weight_caution.png[DRW asac800の重量に関する注意]

. ケーブルマネジメントデバイスを取り付けます（図を参照）。
+
image::../media/drw_asac800_install_cable_mgmt.png[DRW asac800取り付けケーブル管理]
...
image:../media/oie_legend_icon_3_lp.png[""]
 a| 
管理ポートを管理ネットワークスイッチにケーブル接続します    image:../media/drw_asac800_mgmt_cabling.png["システム背面の管理ポートの場所を示す図"]
...
1.
 a| 
ポート 2a~2d を FC ホストスイッチにケーブル接続します。image:../media/drw_asac800_fc_host_cabling.png[""]
...
1.
 a| 
ポート e4A から e4d を 10GbE ホストネットワークスイッチにケーブル接続します。image:../media/drw_asac800_10gbe_host_cabling.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
コントローラ A をシェルフにケーブル接続します。    image:../media/drw_asac800_1shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
コントローラ B をシェルフにケーブル接続します。    image:../media/drw_asac800_1shelf_cabling_b.png[""]
...
image:../media/oie_legend_icon_1_mb.png[""]
 a| 
コントローラ A をシェルフにケーブル接続します。    image:../media/drw_asac800_2shelf_cabling_a.png[""]
...
image:../media/oie_legend_icon_2_lo.png[""]
 a| 
コントローラ B をシェルフにケーブル接続します。    image:../media/drw_asac800_2shelf_cabling_b.png[""]
...
+
image::../media/drw_console_connect_asac800.png[DRWコンソール接続asac800]

.. ラップトップまたはコンソールを管理サブネット上のスイッチに接続します。
+
image::../media/drw_client_mgmt_subnet_asac800.png[DRWクライアント管理サブネットasac800]
