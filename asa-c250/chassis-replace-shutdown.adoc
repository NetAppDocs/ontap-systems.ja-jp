...
---
= シャーシを交換するために ASA C250 コントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF ASA C250ストレージ システムのコントローラーをシャットダウンして、シャーシの交換時にデータ損失を防ぎ、システムの安定性を確保します。
...
.次の手順
コントローラーをシャットダウンした後は、link:chassis-replace-move-hardware.html["ハードウェアを新しいシャーシに移動する"]
