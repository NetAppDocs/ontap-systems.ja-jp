...
summary: システムが修正可能なエラー訂正コードまたは修正不可能なECCエラーの増加を検知した場合は、ASA C250コントローラモジュールのDIMMを交換してください。故障したDIMMを交換しないと、システムパニックを引き起こす可能性があります。 
---
= ASA C250システムのメモリエラーを修正するためにDIMMを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
