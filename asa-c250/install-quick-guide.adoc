...
summary: 印刷可能な図解入りクイックインストール手順書を使用して、ラックの設置、配線、初期システム起動を網羅したASA C250ストレージシステムをインストールします。 
---
= ASA C250ストレージシステムをクイック手順でインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
印刷可能な図解入りクイックインストール手順書を使用して、ラックの設置、配線、初期システム起動を網羅したASA C250ストレージシステムをインストールします。
