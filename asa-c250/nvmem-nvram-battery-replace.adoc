...
summary: ASA C250システムのNVMEMバッテリーを交換するには、コントローラーモジュールをシステムから取り外し、開いてバッテリーを交換し、閉じてコントローラーモジュールを元に戻す必要があります。 
---
= ASA C250 システムの NVMEM バッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C250システムのNVMEMバッテリーを交換するには、コントローラーモジュールをシステムから取り外し、開いてバッテリーを交換し、閉じてコントローラーモジュールを元に戻す必要があります。
