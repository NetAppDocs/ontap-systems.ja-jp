...
summary: ASA C400ストレージシステムのコントローラーをシャットダウンして、ブートメディアを交換する際のデータ損失を防ぎ、システムの安定性を確保します。 
---
= ASA C400 システムの自動ブートリカバリプロセス中にコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C400ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア回復プロセス中のデータ損失を防ぎ、システムの安定性を維持します。
