...
summary: ストレージリソースの制御を交換用コントローラに戻すと、ASA C400 システムは通常動作を再開できます。 
---
= ASA C400システムで通常の動作を再開するためにコントローラーを返却する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージリソースの制御を交換用コントローラに戻すと、ASA C400 システムは通常動作を再開できます。
