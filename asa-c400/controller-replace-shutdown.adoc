...
summary: ASA C400 ストレージ システムのコントローラーをシャットダウンして、コントローラーの交換時にデータ損失を防ぎ、システムの安定性を確保します。 
---
= ASA C400システムの交換前に障害のあるコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C400 ストレージ システムのコントローラーをシャットダウンして、コントローラーの交換時にデータ損失を防ぎ、システムの安定性を確保します。
...
====
.次の手順
ASA C400 コントローラーをシャットダウンした後、link:controller-replace-move-hardware.html["コントローラを交換"]する必要があります。
