...
summary: ASA C400 コントローラモジュールのリアルタイムクロックバッテリを交換して、正確な時刻同期に依存するサービスやアプリケーションが引き続き機能するようにします。 
---
= ASA C400 システムの RTC バッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
コントローラーモジュールのRTCバッテリーを交換することで、ASA C400システムの正確な時刻同期を復元します。
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[コントローラモジュールを取り外します]
...
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[RTCバッテリの取り外し]
