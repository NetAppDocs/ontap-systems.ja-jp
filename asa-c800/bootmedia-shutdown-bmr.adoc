...
summary: ブート メディアを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、ASA C800ストレージ システム内の障害のあるコントローラをシャットダウンします。 
---
= 自動ブートリカバリプロセス中に ASA C800 システムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブート メディア リカバリ プロセス中にデータの損失を防ぎ、システムの安定性を維持するために、 ASA C800 ストレージ システム内の障害のあるコントローラをシャットダウンします。
