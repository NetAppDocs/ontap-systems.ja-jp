...
summary: ブートメディアの交換が必要になったときは、ASA A70またはASA A90ストレージシステムのコントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。 
---
...
[role="lead"]
ブートメディアの交換が必要になったときは、ASA A70またはASA A90ストレージシステムのコントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。
