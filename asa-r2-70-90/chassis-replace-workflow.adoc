...
summary: まず、コントローラをシャットダウンし、シャーシを取り外して交換し、システム動作を確認して、ASA A70またはASA A90ストレージシステムのシャーシを交換します。 
---
...
[role="lead"]
まず、コントローラをシャットダウンし、シャーシを取り外して交換し、システム動作を確認して、ASA A70またはASA A90ストレージシステムのシャーシを交換します。
