...
summary: ASA A70またはASA A90ストレージシステムのコントローラの交換を開始します。まず、障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成をリストアし、ストレージリソースの制御を交換用コントローラに戻します。 
---
= ASA A70またはASA A90コントローラーの交換ワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A70またはASA A90ストレージシステムのコントローラの交換を開始します。まず、障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成をリストアし、ストレージリソースの制御を交換用コントローラに戻します。
