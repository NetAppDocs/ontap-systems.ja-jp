...
summary: ASA A1Kストレージシステムの障害のあるコントローラをシャットダウンしてデータ損失を防ぎ、ブートメディアの交換時にシステムの安定性を確保します。 
---
= 自動ブートリカバリプロセス中に ASA A1K システムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A1Kストレージシステムの障害のあるコントローラをシャットダウンしてデータ損失を防ぎ、ブートメディアの交換時にシステムの安定性を確保します。
