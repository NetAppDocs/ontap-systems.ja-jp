...
summary: ASA A1K ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータの損失を防ぎ、システムの安定性を確保します。 
---
...
[role="lead"]
ASA A1K ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータの損失を防ぎ、システムの安定性を確保します。
