...
summary: ASA A20、ASA A30、またはASA A50ストレージシステムに新しいブートメディアデバイスを取り付けたら、自動ブートメディアリカバリプロセスを開始して、正常なノードから構成をリストアできます。 
---
= 自動ブートリカバリプロセスを使用して ASA A20、ASA A30、または ASA A50 システムでリカバリイメージをブートする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
