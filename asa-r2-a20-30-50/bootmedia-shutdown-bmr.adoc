...
summary: ASA A20、ASA A30、またはASA A50ストレージシステムのコントローラーをシャットダウンして、ブートメディアを交換する際のデータ損失を防ぎ、システムの安定性を確保します。 
---
...
[role="lead"]
ASA A20、ASA A30、またはASA A50ストレージシステムのコントローラーをシャットダウンして、ブートメディアを交換する際のデータ損失を防ぎ、システムの安定性を確保します。
