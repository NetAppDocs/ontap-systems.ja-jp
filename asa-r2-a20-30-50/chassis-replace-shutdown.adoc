...
summary: ASA A20、ASA A30、またはASA A50ストレージシステムのコントローラをシャットダウンして、データ損失を防ぎ、シャーシの交換時にシステムの安定性を確保します。 
---
= シャーシを交換するために ASA A20、ASA A30、または ASA A50 コントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A20、ASA A30、またはASA A50ストレージシステムのコントローラをシャットダウンして、データ損失を防ぎ、シャーシの交換時にシステムの安定性を確保します。
