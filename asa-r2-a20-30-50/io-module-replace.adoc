...
summary: ASA A20、 ASA A30、またはASA A50ストレージシステムのI/Oモジュールに障害が発生した場合、またはモジュールのアップグレードにより、より高いパフォーマンスや追加機能のサポートが必要な場合は、モジュールを交換してください。交換プロセスには、コントローラのシャットダウン、障害のあるI/Oモジュールの交換、コントローラの再起動、そして障害のある部品のNetAppへの返送が含まれます。 
---
= ASA A20、ASA A30、またはASA A50システムのI/Oモジュールを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A20、 ASA A30、またはASA A50ストレージシステムのI/Oモジュールに障害が発生した場合、またはモジュールのアップグレードにより、より高いパフォーマンスや追加機能のサポートが必要な場合は、モジュールを交換してください。交換プロセスには、コントローラのシャットダウン、障害のあるI/Oモジュールの交換、コントローラの再起動、そして障害のある部品のNetAppへの返送が含まれます。
