...
summary: ASA C30ストレージシステムの障害のあるコントローラをシャットダウンしてデータ損失を防ぎ、ブートメディアの交換時にシステムの安定性を確保します。 
---
= 自動ブートリカバリプロセス中に ASA C30 システムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C30ストレージシステムの障害のあるコントローラをシャットダウンしてデータ損失を防ぎ、ブートメディアの交換時にシステムの安定性を確保します。
