...
summary: ストレージリソースの制御を交換用コントローラに戻すと、ASA A250 システムは通常動作を再開できます。 
---
= ASA A250 システムのコントローラーを返却して通常運用を再開する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
復元を完了し、システム構成 ASA A250 システムを確認した後、システムのケーブルを再接続し、ディスクを再割り当てする必要があります。
