...
summary: ASA A250 ストレージ システムのコントローラの交換を開始するには、障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム設定を再構成し、システムの動作を確認します。 
---
= コントローラ交換ワークフロー - ASA A250
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成を復元し、ストレージ リソースの制御を交換用コントローラに戻すことで、ASA A250 ストレージ システムのコントローラを交換します。
