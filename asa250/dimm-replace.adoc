...
[role="lead"]
システムが修正可能なECCエラーの増加を報告している場合は、ASA A250システムのDIMMを交換してください。この手順には、障害のあるコントローラをシャットダウンし、コントローラモジュールを開き、交換用DIMMを取り付けてシステムパニックを防ぐことが含まれます。
