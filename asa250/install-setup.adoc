...
---
= ASA A250ストレージシステムのインストール方法を選択してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A250ストレージシステムのインストールに使用する形式を選択してください：詳細なステップバイステップの手順、簡単な図解ガイド、またはビデオによる説明。

* link:../asa250/install-quick-guide.html["クイックステップ"]
+
ステップバイステップの手順と追加コンテンツへのライブリンクが記載された PDF 形式のガイドです。

* link:../asa250/install-videos.html["ビデオの手順"]
+
手順を追ったビデオでご確認ください。

* link:../asa250/install-detailed-guide.html["詳細な手順"]
+
