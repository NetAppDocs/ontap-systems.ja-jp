...
---
= ASA A250 システムの NVMEM バッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A250 システムで故障した NVMEM バッテリーを交換するには、障害のあるコントローラーをシャットダウンし、コントローラーモジュールを開けて、交換用バッテリーを取り付けます。この手順は、バッテリーの劣化によるキャッシュ書き込みデータの損失を防ぎます。
