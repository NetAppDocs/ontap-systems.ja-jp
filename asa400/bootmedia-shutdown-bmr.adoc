...
summary: ASA A400ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータ損失を防ぎ、システムの安定性を確保します。 
---
= ASA A400 システムの自動ブートリカバリプロセス中にコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A400ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア回復プロセス中のデータ損失を防ぎ、システムの安定性を維持します。
