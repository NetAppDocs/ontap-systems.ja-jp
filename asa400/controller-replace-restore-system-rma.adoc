...
summary: ASA A400 システムのコントローラ交換を完了します。交換用コントローラのライセンスをインストールし、論理インターフェイス（LIF）がホームポートにレポートしていることを確認し、クラスタヘルスチェックを実行します。最後に、障害が発生した部品を NetApp に返却します。 
---
= ASA A400 システムのコントローラー交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A400 システムのコントローラ交換を完了します。交換用コントローラのライセンスをインストールし、論理インターフェイス（LIF）がホームポートにレポートしていることを確認し、クラスタヘルスチェックを実行します。最後に、障害が発生した部品を NetApp に返却します。
