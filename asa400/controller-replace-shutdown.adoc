...
summary: ASA A400 ストレージ システムのコントローラーをシャットダウンして、コントローラーの交換時にデータ損失を防ぎ、システムの安定性を確保します。 
---
= ASA A400システムの交換前に障害のあるコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA A400 ストレージ システムのコントローラーをシャットダウンして、コントローラーの交換時にデータ損失を防ぎ、システムの安定性を確保します。
...
====
.次の手順
ASA A400 コントローラをシャットダウンしたら、link:controller-replace-move-hardware.html["コントローラを交換"]する必要があります。
