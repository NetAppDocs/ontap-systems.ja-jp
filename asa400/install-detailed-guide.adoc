...
summary: ここでは、ASA A400システムのインストールについて、インストールの準備、ハードウェアの設置、コントローラーのケーブル接続、セットアップの完了まで、詳細な手順を説明します。 
---
= 詳細な手順を使用してASA A400ストレージシステムをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ここでは、ASA A400システムのインストールについて、インストールの準備、ハードウェアの設置、コントローラーのケーブル接続、セットアップの完了まで、詳細な手順を説明します。
...
+
image::../media/drw_A400_TNSC-network-cabling.png[2 ノードスイッチレスクラスタのケーブル接続]
...
+
image::../media/drw_a400_two_ns224_shelves.png[NS224シェルフをコントローラにケーブル接続]
...
+
image::../media/drw_a400_three_ds224c_shelves.png[3台のNS224シェルフをコントローラにケーブル接続]
