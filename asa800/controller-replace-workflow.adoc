...
summary: 障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム設定を再構成し、システムの動作を確認して、 ASA A800ストレージ システムのコントローラの交換を開始します。 
---
= コントローラ交換ワークフロー - ASA A800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成を復元し、ストレージ リソースの制御を交換用コントローラに戻すことで、ASA A800ストレージ システム内のコントローラを交換します。
