...
summary: ブート メディアを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、ASA A900ストレージ システム内の障害のあるコントローラをシャットダウンします。 
---
= 自動ブートリカバリプロセス中に ASA A900 システムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ブート メディアを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、ASA A900ストレージ システム内の障害のあるコントローラをシャットダウンします。
