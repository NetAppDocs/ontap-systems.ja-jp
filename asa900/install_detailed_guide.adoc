...
X66240A-5 （ 112-00600 ）、 5m
 a| 
image:../media/oie_cable_sfp_gbe_copper.svg["GbE銅線SFP"]
 a| 
ネットワークケーブル
...
X66033A (112-00438) 、 3m
 a| 
image:../media/oie_cable_fiber_lc_connector.svg["LCファイバコネクタ"]
 a| 
FC 光ネットワーク
...
該当なし
 a| 
image:../media/oie_cable_micro_usb.svg["Micro USBケーブル"]
 a| 
...
該当なし
 a| 
image:../media/oie_cable_power.svg["幅= 85px"]
 a| 
システムの電源をオンにします
...
| ステップ | 各コントローラでを実行します 
 ...
 a| 
image:../media/oie_legend_icon_1_lg.svg["吹き出しアイコン1"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["100Gbケーブル"]
 ...
 a| 
image:../media/oie_legend_icon_2_lp.svg["吹き出しアイコン2"]
 a| 
...
image:../media/oie_cable_rj45.svg["RJ-45ケーブル"]
 ...
 a| 
image:../media/oie_legend_icon_3_o.svg["吹き出しアイコン3"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.svg["100Gbケーブル"]
 ...
 a| 
image:../media/oie_legend_icon_4_dr.svg["吹き出しアイコン4"]
 a| 
32Gb FC 接続のケーブル接続：
...
image:../media/oie_cable_sfp_gbe_copper.svg["GbE銅線SFP"]
 ...
 a| 
image:../media/oie_legend_icon_5_lp.png["吹き出しアイコン5"]
 a| 
...
+
image:../media/drw_a900_switched_network_cabling_IEOPS-934.svg["幅= 500px"]
...
image:../media/drw_a900fas9500_power_icon_IEOPS-1142.svg["幅= 200px"]
...
image:../media/oie_cable_pull_tab_down.svg["幅= 200px"]
...
+
image:../media/drw_a900_NS224_one shelf_cabling_IEOPS-937.svg["幅= 500px"]
...
100GbE ケーブル
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["吹き出しアイコン1"]
 a| 
...
+
image:../media/drw_a900_NS224_line_art_two shelf_cabling_IEOPS-1147.svg["幅= 500px"]

+
image:../media/drw_a900_NS224_two_shelf_cabling_IEOPS-938.svg["幅= 500px"]
...
100GbE ケーブル
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["幅= 30px"]
 a| 
...
シェルフID LED
 ...
 a| 
image:../media/legend_icon_04.svg["幅= 20"]
 a| 
シェルフID設定ボタン
...
+
image:../media/drw_a900_power-on_IEOPS-941.svg["幅= 500px"]
...
+
image:../media/dwr_laptop_to_switch_only.svg["幅= 500px"]

. 検出する ONTAP アイコンを選択します。
+
image:../media/drw_autodiscovery_controler_select.svg["幅= 500px"]
...
シェルフのエンドキャップ
 ...
 a| 
image:../media/legend_icon_02.png["吹き出しアイコン2"]
 a| 
シェルフ前面プレート
 ...
 a| 
image:../media/legend_icon_03.png["吹き出しアイコン3"]
 a| 
シェルフID LED
 ...
 a| 
image:../media/legend_icon_04.png["吹き出しアイコン4"]
 a| 
シェルフID設定ボタン
...
+
画像：[Callout icon one] drw_a900_power-on_ieops-941.svg [width=500px]
