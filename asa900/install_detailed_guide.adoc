...
該当なし
 a| 
image:../media/oie_cable_micro_usb.png["Micro USBケーブル"]
 a| 
...
image:../media/oie_cable_sfp_gbe_copper.png["GbE銅線SFP"]
 ...
 a| 
image:../media/icon_square_4_red.png["吹き出しアイコン5"]
 a| 
...
image:../media/oie_cable100_gbe_qsfp28.png["幅= 50px"]
...
100GbE ケーブル
 ...
 a| 
image:../media/icon_square_2_yellow.png["番号1"]
 a| 
...
100GbE ケーブル
 ...
 a| 
image:../media/icon_square_2_yellow.png["幅= 30px"]
 a| 
...
+
画像：[コールアウト番号1] drw_a900_power-on_ieops-941.svg [width=500px]
