...
summary: 新しいブートメディアデバイスを AFF C30 または AFF C60 ストレージシステムにインストールした後、自動ブートメディアリカバリプロセスを開始して、パートナーノードから構成を復元できます。リカバリプロセス中、システムは暗号化が有効になっているかどうかを確認し、使用されているキー暗号化の種類を特定します。キー暗号化が有効になっている場合、システムはそれを復元するための適切な手順を案内します。 
---
= 自動ブートリカバリプロセスを使用して、AFF C30またはAFF C60ストレージシステムのリカバリイメージを起動します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新しいブートメディアデバイスを AFF C30 または AFF C60 ストレージシステムにインストールした後、自動ブートメディアリカバリプロセスを開始して、パートナーノードから構成を復元できます。リカバリプロセス中、システムは暗号化が有効になっているかどうかを確認し、使用されているキー暗号化の種類を特定します。キー暗号化が有効になっている場合、システムはそれを復元するための適切な手順を案内します。
