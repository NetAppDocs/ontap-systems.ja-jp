...
summary: AFF C30 または AFF C60 ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア復旧プロセス中のデータ損失を防止し、システムの安定性を維持します。 
---
...
[role="lead"]
AFF C30 または AFF C60 ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア復旧プロセス中のデータ損失を防止し、システムの安定性を維持します。
