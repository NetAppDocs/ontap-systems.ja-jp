...
summary: 自動ブート メディア リカバリ プロセス中のデータ損失を防ぎ、システムの安定性を維持するために、 AFF C30 またはAFF C60 ストレージ システム内の障害のあるコントローラをシャットダウンします。 
---
= 自動ブートリカバリプロセス中に AFF C30 または AFF C60 ストレージシステムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブート メディア リカバリ プロセス中のデータ損失を防ぎ、システムの安定性を維持するために、 AFF C30 またはAFF C60 ストレージ システム内の障害のあるコントローラをシャットダウンします。
