...
summary: AFF C30またはAFF C60ストレージシステムのシャーシの交換を開始するには、交換要件の確認、コントローラのシャットダウン、シャーシの取り外しと交換、システム動作の確認を行います。 
---
...
[role="lead"]
AFF C30またはAFF C60ストレージシステムのシャーシの交換を開始するには、交換要件の確認、コントローラのシャットダウン、シャーシの取り外しと交換、システム動作の確認を行います。
