...
summary: AFF C30 または AFF C60 ストレージシステムのインストール要件（必要な機器、持ち上げ時の注意事項、設置場所の仕様など）を確認し、スムーズに設置作業を進めてください。 
---
= AFF C30 および AFF C60 ストレージシステムのインストール要件を確認してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C30 または AFF C60 ストレージシステムのインストール要件（必要な機器、持ち上げ時の注意事項、設置場所の仕様など）を確認し、スムーズに設置作業を進めてください。
