...
summary: AFF C30またはAFF C60ストレージシステムでモジュールに障害が発生し、ストレージシステムがすべてのONTAPバージョン要件を満たしている場合は、Ethernet I/Oモジュールをホットスワップできます。 
---
= AFF C30 または AFF C60 システムの I/O モジュールをホットスワップする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C30またはAFF C60ストレージシステムでモジュールに障害が発生し、ストレージシステムがすべてのONTAPバージョン要件を満たしている場合は、Ethernet I/Oモジュールをホットスワップできます。
...
+
** _I/Oモジュールに不具合のあるコントローラ_とは、I/Oモジュールをホットスワップするコントローラのことです。
** 正常なコントローラは、I/Oモジュールに障害が発生したコントローラのHAパートナーです。
