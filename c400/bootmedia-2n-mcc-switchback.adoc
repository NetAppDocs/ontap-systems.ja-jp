...
---
= AFF C400ストレージシステムの2ノードMetroCluster構成でアグリゲートをスイッチバックする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
2ノード MetroCluster 構成の AFF C400 ストレージシステムでブートメディアの交換が完了したら、MetroCluster スイッチバック操作を実行して、構成を通常の動作状態に戻します。
