...
---
= AFF C400ストレージシステムのブートメディアの暗号化サポートを確認してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
障害のあるコントローラをシャットダウンする前に、AFF C400ストレージシステムのブートメディアの暗号化サポートを確認してください。これには、NetApp Volume Encryption（NVE）とのONTAPバージョン互換性の確認およびキーマネージャ構成の確認が含まれます。
