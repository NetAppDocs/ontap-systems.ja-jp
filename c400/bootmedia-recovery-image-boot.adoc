...
---
= 手動ブートリカバリプロセスを使用して、AFF C400ストレージシステムでリカバリイメージをブートします
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C400 ストレージシステムのリカバリイメージを USB ドライブから起動して、パートナーノードから構成を復元します。

ストレージ システムで ONTAP 9.17.1 以降が実行されている場合は、link:bootmedia-replace-workflow-bmr.html["自動ブート回復手順"]を使用します。
