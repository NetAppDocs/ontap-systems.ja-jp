...
summary: ストレージリソースの制御を交換用コントローラに戻すと、AFF C400 システムは通常動作を再開できます。 
---
= AFF C400ストレージシステムのコントローラーを返却して、通常の動作を再開します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージリソースの制御を交換用コントローラに戻すと、AFF C400 システムは通常動作を再開できます。
