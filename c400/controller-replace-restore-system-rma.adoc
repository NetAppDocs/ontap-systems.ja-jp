...
summary: AFF C400システムのコントローラ交換を完了します。交換用コントローラのライセンスをインストールし、論理インターフェイス（LIF）がホームポートにレポートしていることを確認し、クラスタヘルスチェックを実行します。最後に、障害が発生した部品をNetAppに返却します。 
---
= AFF C400 システムのコントローラー交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C400システムのコントローラ交換を完了します。交換用コントローラのライセンスをインストールし、論理インターフェイス（LIF）がホームポートにレポートしていることを確認し、クラスタヘルスチェックを実行します。最後に、障害が発生した部品をNetAppに返却します。
