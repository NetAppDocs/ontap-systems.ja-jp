...
summary: AFF C400 ストレージ システムのコントローラーをシャットダウンして、コントローラーの交換時にデータ損失を防ぎ、システムの安定性を確保します。 
---
= AFF C400ストレージシステムの障害のあるコントローラーを交換前にシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C400 ストレージ システムのコントローラーをシャットダウンして、コントローラーの交換時にデータ損失を防ぎ、システムの安定性を確保します。
...
====
.次の手順
AFF C400 コントローラをシャットダウンしたら、link:controller-replace-move-hardware.html["コントローラを交換"]する必要があります。
