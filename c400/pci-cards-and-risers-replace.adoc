...
---
= AFF C400ストレージシステムのPCIeカードまたはメザニンカードを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C400ストレージシステムのPCIeカードまたはメザニンカードを交換するには、カードからケーブルとSFP/QSFPモジュールを取り外し、故障したカードを交換して、ケーブルを再接続します。
...
NOTE: 中二階カードのつまみネジを完全に締め付けてください。緩んでいる場合、e0eからe0hまでのポートが検出されない可能性があり、LEDが点滅し続け、ログに「サポートされていないケーブル」エラーが表示される可能性があります。
