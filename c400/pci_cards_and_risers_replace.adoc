...
image:../media/drw_A400_Replace-PCIe-cards_IEOPS-1008.svg["幅= 500px"]
...
image::../media/drw_A400_Replace-mezz-card_IEOPS-1006.svg[DRW A400メザニンカードIEOPS 1006を交換してください]
