...
summary: AFF C80 システムに新しいブート メディア デバイスをインストールした後、USB ドライブからリカバリ イメージを手動で起動して、パートナー ノードから構成を復元できます。 
---
= 手動ブートリカバリプロセスを使用して、AFF C80ストレージシステムのリカバリイメージを起動します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C80 システムに新しいブート メディア デバイスをインストールした後、USB ドライブからリカバリ イメージを手動で起動して、パートナー ノードから構成を復元できます。
