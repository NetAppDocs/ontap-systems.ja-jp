...
summary: AFF C80ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア復旧プロセス中のデータ損失を防止し、システムの安定性を維持します。 
---
...
[role="lead"]
AFF C80ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア復旧プロセス中のデータ損失を防止し、システムの安定性を維持します。
