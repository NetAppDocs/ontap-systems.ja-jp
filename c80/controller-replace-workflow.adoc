...
summary: AFF C80ストレージシステムのコントローラを交換するには、まず、障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成をリストアし、ストレージリソースの制御を交換用コントローラに戻します。 
---
= AFF C80コントローラー交換ワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C80ストレージシステムのコントローラを交換するには、まず、障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成をリストアし、ストレージリソースの制御を交換用コントローラに戻します。
