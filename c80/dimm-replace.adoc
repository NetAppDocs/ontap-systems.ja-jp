...
summary: 修正可能または修正不可能なメモリエラーが大量に検出された場合は、AFF C80システムのDIMMを交換します。このようなエラーが発生すると、ストレージシステムでONTAPをブートできなくなる可能性があります。 
---
= AFF C80ストレージシステムのメモリエラーを修正するためにDIMMを交換してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
