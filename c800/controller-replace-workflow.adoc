...
summary: 障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム設定を再構成し、システムの動作を確認して、 AFF C800ストレージ システムのコントローラの交換を開始します。 
---
= コントローラ交換ワークフロー - AFF C800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF C800ストレージ システムのコントローラを交換するには、障害のあるコントローラをシャットダウンし、コントローラを取り外して交換し、システム構成を復元し、ストレージ リソースの制御を交換用コントローラに戻します。
