...
summary: FAS70 または FAS90 ストレージ システムに新しいブート メディア デバイスをインストールした後、自動ブート メディア回復プロセスを開始して、パートナー ノードから構成を復元できます。 
---
= 自動ブートリカバリプロセスを使用して、FAS70またはFAS90システムでリカバリイメージを起動します。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
