...
summary: FAS70またはFAS90システムに新しいブートメディアデバイスを設置したら、リカバリイメージをUSBドライブからブートし、パートナーノードから構成をリストアできます。 
---
= 手動ブートリカバリプロセスを使用して、FAS70またはFAS90システムでリカバリイメージを起動します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS70 または FAS90 システムに新しいブート メディア デバイスをインストールした後、USB ドライブからリカバリ イメージを手動でブートして、パートナー ノードから構成を復元できます。
