...
summary: ブートメディアを交換する際は、データ損失を防ぎ、システムの安定性を確保するために、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンしてください。 
---
= 自動ブートリカバリプロセス中に、FAS70またはFAS90システムのコントローラをシャットダウンします
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンしてください。
