...
summary: FAS70またはFAS90ストレージ・システムの障害のあるコントローラをシャットダウンして、データ損失を防ぎ、ブート・メディアの交換時にシステムの安定性を確保します。 
---
= 自動起動リカバリプロセス中に、FAS70またはFAS90システム内の障害のあるコントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、FAS70またはFAS90ストレージシステム内の障害が発生したコントローラをシャットダウンしてください。
