...
summary: 手動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンしてください。 
---
= 手動ブートリカバリプロセス中に、FAS70またはFAS90システムのコントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
手動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンしてください。
