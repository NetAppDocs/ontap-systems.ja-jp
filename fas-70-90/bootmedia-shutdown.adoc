...
summary: ブートメディアを交換する必要がある場合は、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。 
---
= コントローラをシャットダウンしてブートメディアを交換します（FAS70およびFAS90）。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ブートメディアを交換する必要がある場合は、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。
