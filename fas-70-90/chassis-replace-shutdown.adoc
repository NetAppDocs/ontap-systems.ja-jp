...
summary: シャーシを交換する際は、データ損失を防ぎ、システムの安定性を維持するために、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンしてください。 
---
= シャーシを交換するために FAS70 または FAS90 コントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシを交換する際は、データ損失を防ぎ、システムの安定性を維持するために、FAS70またはFAS90ストレージシステムのコントローラをシャットダウンしてください。
