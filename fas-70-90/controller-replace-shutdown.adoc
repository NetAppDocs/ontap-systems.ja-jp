...
summary: FAS70またはFAS90ストレージ・システムに障害が発生した場合は、コントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。 
---
...
[role="lead"]
FAS70またはFAS90ストレージ・システムに障害が発生した場合は、コントローラをシャットダウンします。メンテナンスやコンポーネントの交換を行う前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラを安全にシャットダウンすることが重要です。
