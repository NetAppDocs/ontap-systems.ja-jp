...
summary: FAS70およびFAS90システムにIOモジュールを追加することで、ネットワーク接続性を強化し、システムのデータトラフィック処理能力を拡張できます。 
---
= I/Oモジュールの追加- FAS70およびFAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS70およびFAS90システムにI/Oモジュールを追加して、ネットワーク接続を強化し、システムのデータトラフィック処理能力を拡張します。

空きスロットがある場合、またはすべてのスロットに空きがある場合は、FAS70およびFAS90ストレージ・システムにI/Oモジュールを追加できます。
