...
summary: FAS70またはFAS90ストレージシステムのイーサネットI/Oモジュールに障害が発生し、ストレージシステムがすべてのONTAPバージョン要件を満たしている場合、モジュールをホット スワップできます。 
---
= FAS70またはFAS90システムでI/Oモジュールをシャットダウンせずにホット スワップする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS70またはFAS90ストレージシステムのイーサネットI/Oモジュールに障害が発生し、ストレージシステムがすべてのONTAPバージョン要件を満たしている場合、モジュールをホット スワップできます。
...
* ホット スワップ中は、正しいコントローラとI/Oスロットにコマンドを適用していることを確認してください。
+
...
== ステップ3：故障したI/Oモジュールを交換する

故障したI/Oモジュールを、同等のI/Oモジュールとホットスワップしてください。
