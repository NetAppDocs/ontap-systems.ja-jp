...
summary: FAS2600システムのシャーシ交換を完了するには、シャーシのHA状態を確認し、故障したコンポーネントをNetAppに返送してください。 
---
= FAS2600 システムのシャーシ交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシのHA状態を確認し、キットに同梱されているRMA手順書に記載されているとおりに故障した部品を NetApp に返送することで、FAS2600システムのシャーシ交換を完了してください。
