...
summary: シャーシを交換する前に、お使いの構成に応じた適切な手順に従って、FAS2600システム内の故障したコントローラをシャットダウンするか、制御を切り替えてください。 
---
= シャーシを交換するために FAS2600 コントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシを交換する前に、お使いの構成に応じた適切な手順に従って、FAS2600システム内の故障したコントローラをシャットダウンするか、制御を切り替えてください。
