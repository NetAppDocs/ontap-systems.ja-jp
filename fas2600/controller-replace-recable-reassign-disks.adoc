...
summary: ストレージのケーブルを再接続し、ディスクの再割り当てを確認し、残りのタスクを完了してコントローラを返却し、FAS2600 システムを完全に動作可能な状態に復元します。 
---
= FAS2600システムのコントローラーを元に戻して、通常の動作を再開してください。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージのケーブルを再接続し、ディスクの再割り当てを確認し、残りのタスクを完了してコントローラを返却し、FAS2600 システムを完全に動作可能な状態に復元します。
