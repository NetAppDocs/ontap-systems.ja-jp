...
summary: FAS2600システム内の障害コントローラを交換する前に、その状態を確認し、必要に応じてテイクオーバーを実行することで障害コントローラをシャットダウンしてください。これにより、正常なコントローラが引き続きデータを提供できます。 
---
= 交換前に、FAS2600システム内の障害コントローラをシャットダウンしてください。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2600システム内の障害コントローラを交換する前に、その状態を確認し、必要に応じてテイクオーバーを実行することで障害コントローラをシャットダウンしてください。これにより、正常なコントローラが障害コントローラのストレージからデータを引き続き提供できるようになります。
