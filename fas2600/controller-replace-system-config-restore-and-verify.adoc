...
summary: ハードウェア交換とメンテナンスモードでの起動が完了したら、FAS2600 システムのコントローラ構成を復元して確認してください。 
---
= FAS2600システムでコントローラ構成を復元および検証する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ハードウェア交換とメンテナンスモードでの起動が完了したら、FAS2600システムでコントローラ構成を復元および検証し、交換用コントローラの低レベルシステム構成を確認し、必要に応じてシステム設定を再構成してください。
