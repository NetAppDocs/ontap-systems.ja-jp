...
summary: FAS2700システムのシャーシ交換を完了するには、シャーシのHA状態を確認し、障害のあるコンポーネントをNetAppに返送してください。 
---
= FAS2700システムのシャーシ交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2700システムのシャーシ交換を完了するには、シャーシのHA状態を確認し、障害のあるコンポーネントをNetAppに返送してください。
