...
summary: FAS2700システム内の障害コントローラを交換する前に、テイクオーバーを実行してLOADERプロンプトに停止させ、シャットダウンしてください。 
---
= 交換前に、FAS2700システム内の障害コントローラをシャットダウンしてください。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2700システム内の障害コントローラを交換する前に、テイクオーバーを実行してLOADERプロンプトに停止させ、シャットダウンしてください。
