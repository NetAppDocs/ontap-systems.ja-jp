...
summary: ハードウェア交換とメンテナンスモードでの起動が完了したら、FAS2700システムのコントローラ構成を復元して確認してください。 
---
= FAS2700システムでコントローラ構成を復元および検証する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ハードウェア交換とメンテナンスモードでの起動が完了したら、FAS2700システムのコントローラ構成を復元して確認してください。
