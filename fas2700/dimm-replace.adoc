...
summary: ストレージシステムで過剰な訂正可能なECCエラーまたは訂正不可能なECCエラーが発生した場合は、FAS2700システムのDIMMを交換してください。これらのエラーは通常、単一のDIMMの障害によって発生します。 
---
= FAS2700システムのDIMMを交換してメモリエラーを修正する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージシステムで過剰な訂正可能なECCエラーまたは訂正不可能なECCエラーが発生した場合は、FAS2700システムのDIMMを交換してください。これらのエラーは通常、単一のDIMMの障害によって発生します。
