...
summary: FAS2700システムをインストールおよびセットアップするには、さまざまなコンテンツ形式から選択してください。 
---
= FAS2700 ストレージシステムのインストール方法を選択してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2700システムをインストールおよびセットアップするには、さまざまなコンテンツ形式から選択してください。
