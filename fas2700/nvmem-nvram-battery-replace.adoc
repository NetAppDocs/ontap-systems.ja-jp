...
summary: FAS2700システムのNVMEMバッテリーを交換するには、コントローラーモジュールを取り外し、バッテリーを交換してから、コントローラーモジュールを再取り付けします。 
---
= FAS2700システムのNVMEMバッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2700システムのNVMEMバッテリーを交換するには、コントローラーモジュールを取り外し、バッテリーを交換してから、コントローラーモジュールを再取り付けします。
...
+
image::../media/drw_2600_nvmem_batt_repl_animated_gif.png[NVMEM バッテリの交換]
