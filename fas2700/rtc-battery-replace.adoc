...
summary: FAS2700システムのリアルタイムクロックバッテリーを交換して、正確な時刻同期に依存するサービスやアプリケーションが引き続き機能するようにします。 
---
= FAS2700システムのリアルタイムクロックバッテリーを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2700システムのリアルタイムクロック（RTC）バッテリーを交換して、正確な時刻同期に依存するサービスやアプリケーションが引き続き機能するようにしてください。
