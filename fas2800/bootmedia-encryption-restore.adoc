...
summary: FAS2820システムの交換用ブートメディアの暗号化を復元します。 
---
= FAS2820 システムのブートメディアの暗号化を手動ブートリカバリプロセス後に復元する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2820 システムのブートメディアを交換したら、新しいデバイスで暗号化を復元してデータセキュリティを維持し、システムを元の構成に戻します。
