...
summary: 新しいブートメディアデバイスを FAS2820 システムにインストールした後、USBドライブからリカバリイメージを手動で起動して、パートナーノードから構成を復元できます。 
---
= 手動ブートリカバリプロセスを使用して FAS2820 システムでリカバリイメージをブートする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新しいブートメディアデバイスを FAS2820 システムにインストールした後、USBドライブからリカバリイメージを手動で起動して、パートナーノードから構成を復元できます。
