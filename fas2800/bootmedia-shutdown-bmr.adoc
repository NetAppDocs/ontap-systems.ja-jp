...
summary: FAS2820ストレージシステムで障害のあるコントローラーをシャットダウンして、ブートメディアを交換する際のデータ損失を防ぎ、システムの安定性を維持します。 
---
= FAS2820 システムの自動ブートリカバリプロセス中に障害コントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2820ストレージ システムで障害のあるコントローラをシャットダウンし、自動ブート メディア リカバリ プロセス中のデータ損失を防ぎ、システムの安定性を維持します。
