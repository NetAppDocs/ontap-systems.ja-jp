...
summary: ブート メディアを交換するときにデータの損失を防ぎ、システムの安定性を確保するために、FAS2800 ストレージ システム内の障害のあるコントローラをシャットダウンします。 
---
= 自動ブートメディアリカバリのためにコントローラをシャットダウンする - FAS2800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブート メディア回復プロセス中にデータの損失を防ぎ、システムの安定性を維持するために、FAS2800 ストレージ システム内の障害のあるコントローラをシャットダウンします。
