...
summary: FAS2820システムのシャーシを交換する前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラーを正常にシャットダウンする必要があります。 
---
= シャーシを交換するためにFAS2820コントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS2820システムのシャーシを交換する前に、データ損失を防ぎ、システムの安定性を確保するために、コントローラーを正常にシャットダウンする必要があります。
