...
summary: FAS50システムの交換用ブートメディアで暗号化をリストアして、データを継続的に保護します。交換プロセスには、キーの可用性の確認、暗号化設定の再適用、およびデータへのセキュアなアクセスの確認が含まれます。 
---
= リストア暗号化- FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
FAS50システムの交換用ブートメディアで暗号化をリストアして、データを継続的に保護します。交換プロセスには、キーの可用性の確認、暗号化設定の再適用、およびデータへのセキュアなアクセスの確認が含まれます。
