...
summary: FAS50システムに新しいブートメディアデバイスを設置したら、リカバリイメージをUSBドライブからブートし、パートナーノードから構成をリストアできます。 
---
= リカバリイメージのブート- FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
FAS50システムに新しいブートメディアデバイスを設置したら、リカバリイメージをUSBドライブからブートし、パートナーノードから構成をリストアできます。
