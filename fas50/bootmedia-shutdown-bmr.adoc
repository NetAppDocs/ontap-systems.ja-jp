...
summary: 自動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、FAS50ストレージシステムのコントローラをシャットダウンしてください。 
---
= 自動起動リカバリプロセス中にFAS50システムのコントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブートメディア復旧プロセス中にデータ損失を防ぎ、システムの安定性を維持するために、FAS50ストレージシステムのコントローラをシャットダウンしてください。
