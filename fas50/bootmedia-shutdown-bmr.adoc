...
summary: 自動ブート メディア回復プロセス中にデータの損失を防ぎ、システムの安定性を維持するために、FAS50 ストレージ システム内の障害のあるコントローラをシャットダウンします。 
---
= 自動起動リカバリプロセス中に、FAS50システム内の障害のあるコントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
自動ブート メディア回復プロセス中にデータの損失を防ぎ、システムの安定性を維持するために、FAS50 ストレージ システム内の障害のあるコントローラをシャットダウンします。
