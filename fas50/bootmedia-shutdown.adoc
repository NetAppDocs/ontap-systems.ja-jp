...
summary: 手動ブート メディア回復プロセス中にデータの損失を防ぎ、システムの安定性を維持するために、FAS50 ストレージ システム内の障害のあるコントローラをシャットダウンします。 
---
= 手動ブートリカバリプロセス中に、FAS50システム内の障害のあるコントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
手動ブート メディア回復プロセス中にデータの損失を防ぎ、システムの安定性を維持するために、FAS50 ストレージ システム内の障害のあるコントローラをシャットダウンします。
