...
summary: FAS50ストレージシステムの障害のあるコントローラをシャットダウンしてデータ損失を防止し、ブートメディアの交換時にシステムの安定性を確保します。 
---
= コントローラをシャットダウンしてブートメディアを交換します- FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS50ストレージシステムの障害のあるコントローラをシャットダウンしてデータ損失を防止し、ブートメディアの交換時にシステムの安定性を確保します。
