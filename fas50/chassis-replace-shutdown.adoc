...
summary: FAS50ストレージ・システムのコントローラをシャットダウンして、データ損失を防ぎ、シャーシの交換時にシステムの安定性を確保します。 
---
= シャーシを交換するために FAS50 コントローラをシャットダウンします。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS50ストレージ・システムのコントローラをシャットダウンして、データ損失を防ぎ、シャーシの交換時にシステムの安定性を確保します。
