...
summary: FAS50ストレージシステムのコントローラを交換する前に、交換を成功させるために必要な要件を満たしていることを確認してください。これには、システム内の他のすべてのコンポーネントが正しく機能していることを確認すること、正しい交換用コントローラを使用していることを確認すること、およびコントローラのコンソール出力をテキストログファイルに保存することが含まれます。 
---
= FAS50システムのコントローラを交換する前に、要件を確認してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS50ストレージシステムのコントローラを交換する前に、交換を成功させるために必要な要件を満たしていることを確認してください。これには、システム内の他のすべてのコンポーネントが正しく機能していることを確認すること、正しい交換用コントローラを使用していることを確認すること、およびコントローラのコンソール出力をテキストログファイルに保存することが含まれます。
