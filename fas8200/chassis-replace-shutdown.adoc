...
summary: シャーシを交換する前に、FAS8200システムの障害のあるコントローラーをシャットダウンする必要があります。 
---
= シャーシを交換するために FAS8200 コントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
シャーシを交換する前に、FAS8200システムの障害のあるコントローラーをシャットダウンする必要があります。
