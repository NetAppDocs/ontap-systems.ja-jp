...
summary: コントローラーを交換した後、システムを再接続し、ディスクの所有権が再割り当てされていることを確認することで、FAS8200システムは通常の動作を再開できます。 
---
= FAS8200システムでコントローラーをギブバックして通常運用を再開する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
コントローラーを交換した後、システムを再接続し、ディスクの所有権が再割り当てされていることを確認することで、FAS8200システムは通常の動作を再開できます。
