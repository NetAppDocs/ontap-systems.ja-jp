...
summary: お客様の FAS8200 システムを完全に復旧するには、（必要に応じて）NetApp Storage Encryption 構成を復元し、新しいコントローラーのライセンスをインストールして、キットに付属の RMA 手順書の説明に従って障害パーツを NetApp に返却します。 
---
= FAS8200システムのコントローラーの交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
お客様の FAS8200 システムを完全に復旧するには、（必要に応じて）NetApp Storage Encryption 構成を復元し、新しいコントローラーのライセンスをインストールして、キットに付属の RMA 手順書の説明に従って障害パーツを NetApp に返却します。
