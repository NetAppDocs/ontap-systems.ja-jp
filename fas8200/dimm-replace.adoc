...
summary: ストレージシステムがヘルスモニターアラートで検出した過剰な訂正可能エラー訂正コード（CECC）エラー、または単一のDIMMの故障によって発生した訂正不能なECCエラーを報告し、ストレージシステムのONTAPの起動が妨げられる場合は、コントローラモジュール内のDIMMを交換する必要があります。 
---
= FAS8200システムのDIMMを交換してメモリエラーを修正する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージシステムがヘルスモニターアラートで検出した過剰な訂正可能エラー訂正コード（CECC）エラー、または単一のDIMMの故障によって発生した訂正不能なECCエラーを報告し、ストレージシステムのONTAPの起動が妨げられる場合は、コントローラモジュール内のDIMMを交換する必要があります。
