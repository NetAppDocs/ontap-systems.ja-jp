...
summary: PCIeカードを交換するには、まずシステムからコントローラモジュールを取り外し、サイドパネルを開け、故障したカードを取り外し、交換用カードを取り付け、最後にコントローラモジュールを再度取り付ける必要があります。 
---
= FAS8200 システムの PCIe カードを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
PCIeカードを交換するには、まずシステムからコントローラモジュールを取り外し、サイドパネルを開け、故障したカードを取り外し、交換用カードを取り付け、最後にコントローラモジュールを再度取り付ける必要があります。
