...
summary: コントローラーモジュール内のリアルタイム時計用バッテリーを交換することで、正確な時刻同期に依存するサービスやアプリケーションが引き続き機能するようになります。 
---
= FAS8200システムのリアルタイムクロックバッテリを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. RTC バッテリの場所を確認します。
+
image::../media/drw_rxl_rtc_battery.png[RTCバッテリの取り外しと交換]
...
== ステップ4：RTCバッテリー交換後、コントローラーモジュールを再インストールし、時刻と日付をリセットする
