...
---
= FAS8300またはFAS8700システムで手動ブートリカバリプロセス後にブートメディアの暗号化を復元します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS8300またはFAS8700システムのブートメディアを交換した後、Onboard Key Manager（OKM）などのキーマネージャータイプに応じた手順を実行して、暗号化を復元してください。
