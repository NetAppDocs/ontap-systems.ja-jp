...
summary: 新しいブートメディアデバイスをFAS8300またはFAS8700システムにインストールした後、自動ブートメディアリカバリプロセスを開始して、パートナーノードから構成を復元することができます。 
---
= 自動ブートリカバリプロセスを使用して FAS8300 または FAS8700 システムでリカバリイメージをブートする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
