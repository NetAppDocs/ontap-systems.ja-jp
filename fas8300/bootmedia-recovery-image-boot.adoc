...
---
= 手動ブートリカバリプロセスを使用して FAS8300 または FAS8700 システムでリカバリイメージをブートする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新しいブートメディアデバイスをFAS8300またはFAS8700システムにインストールした後、USBドライブからリカバリイメージを起動し、パートナーノードから構成を復元することができます。
