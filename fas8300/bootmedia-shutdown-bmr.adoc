...
summary: FAS8300またはFAS8700ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータ損失を防ぎ、システムの安定性を確保してください。 
---
= 自動ブートリカバリプロセス中に FAS8300 または FAS8700 システムのコントローラをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS8300またはFAS8700ストレージシステムのコントローラーをシャットダウンして、ブートメディアの交換時にデータ損失を防ぎ、システムの安定性を確保してください。
