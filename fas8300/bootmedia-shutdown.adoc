...
---
= FAS8300またはFAS8700システムの手動ブートリカバリプロセス中に障害のあるコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NVEまたはNSEタスクが完了したら、構成に応じた手順に従って、障害が発生したコントローラをシャットダウンまたはテイクオーバーしてください。
...
NVEまたはNSEタスクが完了したら、障害のあるコントローラをシャットダウンします。
