...
summary: ストレージリソースの制御を交換用コントローラに戻して、FAS8300またはFAS8700システムが通常動作を再開できるようにします。 
---
= FAS8300またはFAS8700システムで通常運用を再開するためにコントローラーをギブバックする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージリソースの制御を交換用コントローラに戻して、FAS8300またはFAS8700システムが通常動作を再開できるようにします。
