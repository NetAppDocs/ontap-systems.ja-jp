...
summary: ストレージリソースの制御を交換用コントローラに戻すと、FAS8300およびFAS8700システムは通常動作を再開できます。 
---
= コントローラを返却する - FAS8300 および FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ストレージリソースの制御を交換用コントローラに戻すと、FAS8300およびFAS8700システムは通常動作を再開できます。
