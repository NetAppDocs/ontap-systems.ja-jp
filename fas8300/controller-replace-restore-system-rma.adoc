...
summary: FAS8300およびFAS8700システムのコントローラ交換を完了します。交換用コントローラのライセンスをインストールし、論理インターフェイス（LIF）がホームポートにレポートしていることを確認し、クラスタヘルスチェックを実行します。最後に、障害が発生した部品をNetAppに返却します。 
---
= コントローラの完全交換- FAS8300およびFAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS8300およびFAS8700システムのコントローラ交換を完了します。交換用コントローラのライセンスをインストールし、論理インターフェイス（LIF）がホームポートにレポートしていることを確認し、クラスタヘルスチェックを実行します。最後に、障害が発生した部品をNetAppに返却します。
