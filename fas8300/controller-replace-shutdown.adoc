...
summary: FAS8300およびFAS8700ストレージシステムのコントローラの電源をオフにして、コントローラ交換時のデータ損失を防ぎ、システムの安定性を確保します。 
---
= 障害のあるコントローラ FAS8300 および FAS8700 をシャットダウンします
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS8300およびFAS8700ストレージシステムのコントローラの電源をオフにして、コントローラ交換時のデータ損失を防ぎ、システムの安定性を確保します。
