...
summary: データ損失を防ぎ、システムの安定性を確保するために、コントローラーを交換する際は FAS8300 または FAS8700 ストレージシステムのコントローラーをシャットダウンしてください。 
---
= FAS8300またはFAS8700システムで障害のあるコントローラーを交換前にシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
データ損失を防ぎ、システムの安定性を確保するために、コントローラーを交換する際は FAS8300 または FAS8700 ストレージシステムのコントローラーをシャットダウンしてください。
...
====
.次の手順
FAS8300 および FAS8700 コントローラーをシャットダウンしたら、link:controller-replace-move-hardware.html["コントローラを交換"]する必要があります。
