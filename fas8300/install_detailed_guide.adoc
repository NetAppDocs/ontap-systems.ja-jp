...
+
image::../media/drw_fas8300_TNSC_network_cabling.png[DRW fas8300 TNSC ネットワークケーブル接続]
...
+
image::../media/drw_fas8300_switched_network_cabling.png[DRW fas8300 スイッチドネットワークケーブル接続]
...
+
image::../media/drw_fas8300_three-ds224c_shelves.png[DRW fas8300 3 ds224c シェルフ]
