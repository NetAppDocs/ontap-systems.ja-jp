...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=80c4701e-8e4a-408e-96e6-ab1b00666d3f["2 ノードスイッチレスクラスタのケーブル接続"]



image::../media/drw_A400_TNSC_network_cabling.png[DRW A400 TNSC ネットワークケーブル配線]
...
. アニメーションや図を使用して、コントローラとスイッチをケーブルで接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=5893b7d4-6f67-4a64-ad89-ab1b006658d1["スイッチクラスタのケーブル接続"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=46c0da0b-6842-449f-b28c-ab1b0066584b["SAS ドライブシェルフへのコントローラのケーブル接続"]
...
. 次のアニメーションまたは図を使用して、ラップトップを管理スイッチに接続します。
+
