...
---
= NVDIMM バッテリの交換 - FAS8300 および FAS8700
:icons: font
:imagesdir: ../media/
...
次に示すアニメーションや図の手順に従って、 NVDIMM バッテリを交換します。
...
** スキャンでエラーが報告されなかった場合は、メニューから [Reboot] を選択してシステムを再起動します。
