...
---
= 2ノードMetroCluster構成でのアグリゲートのスイッチバック- FAS9000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ブート メディアの交換が完了したら、 MetroClusterスイッチバック操作を実行します。FAS9000システムは、手動のブート メディア回復手順のみをサポートします。自動ブート メディア リカバリはサポートされていません。
