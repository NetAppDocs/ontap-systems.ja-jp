...
summary: '環境変数を確認したら、Onboard Key Manager (OKM)、 NetApp Storage Encryption (NSE)、またはNetApp Volume Encryption (NVE) が有効になっているシステムに固有の手順を完了する必要があります。FAS9000システムは、手動のブート メディア回復手順のみをサポートします。' 
---
= リストア暗号化- FAS9000
:allow-uri-read: 
:icons: font
