...
summary: FAS9000システムが、モジュールがオフラインになったことを報告する単一のAutoSupport（ASUP）メッセージを登録した場合は、キャッシュモジュールまたはコアダンプモジュールを交換してください。交換を怠ると、性能低下につながります。 
---
= FAS9000システムのキャッシュモジュールまたはコアダンプモジュールを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムが、モジュールがオフラインになったことを報告する単一のAutoSupport（ASUP）メッセージを登録した場合は、キャッシュモジュールまたはコアダンプモジュールを交換してください。交換を怠ると、性能低下につながります。
