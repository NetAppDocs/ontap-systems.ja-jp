...
summary: FAS9000システムのキャッシュモジュールをホットスワップします。ONTAP 9.4以降では、スロット6のNVRAM10モジュールの前面に配置されたNVMe SSD Flash Cacheモジュールを、同じまたは異なるサポート対象ベンダーの同じ容量のキャッシュモジュールとホットスワップできます。 
---
= FAS9000システムのキャッシュモジュールをホットスワップする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムのキャッシュモジュールをホットスワップします。ONTAP 9.4以降では、スロット6のNVRAM10モジュールの前面に配置されたNVMe SSD Flash Cacheモジュールを、同じまたは異なるサポート対象ベンダーの同じ容量のキャッシュモジュールとホットスワップできます。
