...
summary: FAS9000システムでシャーシの交換を完了するには、シャーシのHA状態を確認し、キットに同梱されているRMA手順書に記載されているとおりに、故障した部品をNetAppに返送してください。 
---
= FAS9000 システムのシャーシ交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムでシャーシの交換を完了するには、シャーシのHA状態を確認し、キットに同梱されているRMA手順書に記載されているとおりに、故障した部品をNetAppに返送してください。
