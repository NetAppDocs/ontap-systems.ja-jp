...
summary: 交換手順を完了してシステムを完全に動作状態に戻すには、ストレージを再配線し、必要に応じてNetApp Storage Encryptionの設定を復元し、新しいコントローラーのライセンスをインストールします。 
---
= FAS9000システムのコントローラーの交換を完了する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムのコントローラー交換を完了するには、ストレージのケーブルを再接続し、必要に応じてNetApp Storage Encryptionの設定を復元し、新しいコントローラーのライセンスをインストールします。
...
== ステップ3（MetroCluster のみ）：2ノードMetroCluster構成でアグリゲートをスイッチバックします
