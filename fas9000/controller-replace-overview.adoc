...
summary: FAS9000 システムのコントローラーを交換する前に、交換手順の前提条件を確認し、お使いの ONTAP のバージョンに適した手順を選択してください。 
---
= FAS9000システムでコントローラーを交換する前に要件を確認してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000 システムのコントローラーを交換する前に、交換手順の前提条件を確認し、お使いの ONTAP のバージョンに適した手順を選択してください。
