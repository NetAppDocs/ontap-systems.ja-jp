...
summary: FAS9000システムでストレージを再配線してディスクの再割り当てを確認し、交換用コントローラーが正常な動作を再開できるようにします。 
---
= FAS9000システムでコントローラーをギブバックして通常運用を再開する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムでストレージを再配線してディスクの再割り当てを確認し、交換用コントローラーが正常な動作を再開できるようにします。
...
使用する手順は、コントローラの冗長構成によって異なります。

[role="tabbed-block"]
====
.オプション1: HAペア
--
=== HA システムでのシステム ID の変更を確認する
...
--
.オプション2: 2ノードMetroCluster
--
=== 2ノードMetroCluster構成のシステムでシステムIDを手動で再割り当てする
