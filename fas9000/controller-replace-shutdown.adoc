...
summary: FAS9000システムで障害のあるコントローラーをシャットダウンまたはテイクオーバーするには、構成に応じた適切な手順を使用して、正常なノードが障害ノードのストレージからデータを引き続き提供できるようにします。 
---
= FAS9000システムで障害のあるコントローラーを交換前にシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000 システムで障害のあるコントローラーをシャットダウンまたはテイクオーバーするには、お使いの構成に適した手順を使用してください。
