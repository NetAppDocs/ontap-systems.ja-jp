...
summary: FAS9000 システムでコントローラーのハードウェア交換を完了してメンテナンスモードで起動した後、交換用コントローラーの低レベルシステム構成を確認し、必要に応じてシステム設定を再構成します。 
---
= FAS9000 システムでコントローラー構成を復元して検証する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000 システムでコントローラーのハードウェア交換を完了してメンテナンスモードで起動した後、交換用コントローラーの低レベルシステム構成を確認し、必要に応じてシステム設定を再構成します。
