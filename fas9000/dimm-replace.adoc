...
summary: FAS9000システムがヘルスモニターアラートを通じて過剰な修正可能なECCメモリエラー、または修正不可能なECCエラーを報告した場合は、DIMMを交換してください。DIMMの故障により、ストレージシステムがONTAPを起動できなくなる可能性があるため、交換することで安定した動作が回復します。 
---
= FAS9000 システムの DIMM を交換してメモリエラーを修正する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムがヘルスモニターアラートを通じて過剰な修正可能なECCメモリエラー、または修正不可能なECCエラーを報告した場合は、DIMMを交換してください。DIMMの故障により、ストレージシステムがONTAPを起動できなくなる可能性があるため、交換することで安定した動作が回復します。
