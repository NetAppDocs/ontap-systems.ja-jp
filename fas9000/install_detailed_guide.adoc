...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=7a55b98a-e8b8-41d5-821f-ac5b0032ead0["2 ノードスイッチレスクラスタのケーブル接続"]



image::../media/drw_9000_TNSC_composite_cabling.png[DRW 9000 TNSC 複合ケーブル]

. に進みます <<Step 4: Cable controllers to drive shelves>> ドライブシェルフのケーブル接続手順については、を参照して
...
. アニメーションや図を使用して、コントローラとスイッチをケーブルで接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6381b3f1-4ce5-4805-bd0a-ac5b0032f51d["スイッチクラスタのケーブル接続"]
...
.手順
. 次のアニメーションに従って、ドライブシェルフをコントローラにケーブル接続します。
+
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=a312e09e-df56-47b3-9b5e-ab2300477f67["SAS ストレージのケーブル接続 - ONTAP 9.7 以前"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=61d23302-9526-4a2b-9335-ac5b0032eafd["SAS ストレージのケーブル接続 - ONTAP 9.8 以降"]
...
+
link:..https://docs.netapp.com/us-en/ontap-systems/sas3/install-new-system.html["IOM12 モジュールを搭載した新しいシステム設置用シェルフを設置してケーブル接続します"]

+
image:../media/Cable_shelves_new_system_IOM12_shelves.png[""]

. に進みます <<Step 5: Complete system setup and configuration>> をクリックして、システムのセットアップと設定を完了します。
...
* 各コントローラのスロット 3 または 7 に、少なくとも 1 つの X91148A モジュールをインストールする必要があります。このアニメーションでは、このモジュールがスロット 3 と 7 の両方に取り付けられていることを示します。
...
.手順
. 次のアニメーションに従って、 2 つの X91148A ストレージモジュールを搭載するコントローラを 1 台の NS224 ドライブシェルフにケーブル接続するか、図を使用して 1 つの X91148A ストレージモジュールを搭載するコントローラを 1 台の NS224 ドライブシェルフにケーブル接続します。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6520eb01-87b3-4520-9109-ac5b0032ea4e["1 台の NS224 シェルフのケーブル接続 - ONTAP 9.8 以降"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=34098e39-73ad-45de-9af7-ac5b0032ea9a["2 台の NS224 シェルフのケーブル接続 - ONTAP 9.8 以降"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=95a29da1-faa3-4ceb-8a0b-ac7600675aa6["SAS または NVMe ドライブシェルフ ID を設定しています"]

. 電源コードをコントローラの電源装置に接続し、さらに別の回路の電源に接続します。
. 両方のノードの電源スイッチをオンにします。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bb04eb23-aa0c-4821-a87d-ab2300477f8b["コントローラの電源をオンにします"]
