...
summary: NVRAM モジュールは、NVRAM10 と DIMM 、および NVRAM モジュールあたり最大 2 つの NVMe SSD Flash Cache モジュール、 Flash Cache またはキャッシュモジュールで構成されます。 
---
= FAS9000システムのNVRAMモジュールまたはNVRAM DIMMを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
