...
summary: FAS9000システムで、故障したNVRAMモジュール、またはNVRAMモジュール内部のDIMMを交換します。システムIDはNVRAMモジュールから派生するため、モジュールを交換すると、そのシステムに属するディスクが新しいシステムIDに再割り当てされます。 
---
= FAS9000システムのNVRAMモジュールまたはNVRAM DIMMの交換
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムで、故障したNVRAMモジュール、またはNVRAMモジュール内部のDIMMを交換します。システムIDはNVRAMモジュールから派生するため、モジュールを交換すると、そのシステムに属するディスクが新しいシステムIDに再割り当てされます。
