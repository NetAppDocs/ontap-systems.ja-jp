...
summary: FAS9000システムのI/Oモジュールを交換するには、システムが実行するすべてのバージョンの ONTAP でサポートされている特定のタスクシーケンスを使用します。 
---
= FAS9000システムのI/Oモジュールを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9000システムのI/Oモジュールを交換するには、システムが実行するすべてのバージョンの ONTAP でサポートされている特定のタスクシーケンスを使用します。
