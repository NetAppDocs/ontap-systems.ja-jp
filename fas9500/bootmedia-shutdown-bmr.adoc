...
summary: FAS9500ストレージシステムのコントローラーをシャットダウンして、ブートメディアを交換する際のデータ損失を防ぎ、システムの安定性を確保してください。 
---
= 自動ブートリカバリプロセス中に FAS9500 システムのコントローラーをシャットダウンする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS9500ストレージシステムのコントローラーをシャットダウンして、自動ブートメディア回復プロセス中のデータ損失を防ぎ、システムの安定性を維持します。
