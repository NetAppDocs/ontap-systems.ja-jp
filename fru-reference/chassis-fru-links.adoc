...
summary: プラットフォーム ファミリ別に整理されたNetAppストレージ システムのシャーシ交換手順を確認します。このリファレンスには、 AFF、 ASA、およびFASシステムのシャーシ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。 
---
= プラットフォームファミリー別のシャーシ交換手順
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
プラットフォーム ファミリ別に整理されたNetAppストレージ システムのシャーシ交換手順を確認します。このリファレンスには、 AFFおよびFASシステムのシャーシ交換ワークフローのステップバイステップの直接リンクが提供されており、特定のモデルに適切な手順をすばやく見つけるのに役立ちます。
...
* link:../a900/chassis_replace_overview.html["AFF A900 の略"]
...
* link:../c80/chassis-replace-workflow.html["AFF C80用"]
