...
summary: プラットフォーム ファミリ別に整理されたNetAppストレージ システムのコントローラ交換手順を見つけます。このリファレンスには、 AFF、 ASA、およびFASシステムのコントローラ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。 
---
= プラットフォームファミリー別のコントローラー交換手順
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
プラットフォーム ファミリ別に整理されたNetAppストレージ システムのコントローラ交換手順を見つけます。このリファレンスには、 AFF、 ASA、およびFASシステムのコントローラ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。
...
* link:../a1k/controller-replace-workflow.html["AFF A1K用"]
...
* link:../a900/controller_replace_overview.html["AFF A900 の略"]
...
* link:../c80/controller-replace-workflow.html["AFF C80用"]
