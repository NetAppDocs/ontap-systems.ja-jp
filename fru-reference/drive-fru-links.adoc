...
summary: プラットフォーム ファミリ別に整理されたNetAppストレージ システムのドライブ交換手順を見つけます。このリファレンスには、 AFF、 ASA、およびFASシステムのドライブ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。 
---
...
[role="lead"]
プラットフォーム ファミリ別に整理されたNetAppストレージ システムのドライブ交換手順を見つけます。このリファレンスには、 AFF、 ASA、およびFASシステムのドライブ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。
