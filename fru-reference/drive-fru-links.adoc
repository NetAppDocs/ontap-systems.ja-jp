...
summary: プラットフォームまたはシェルフ ファミリ別に整理されたNetAppストレージ システムのドライブ交換手順を見つけます。このリファレンスには、 AFF、 ASA、 FASシステム、およびシェルフ システムのドライブ交換ワークフローの手順への直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。 
---
= プラットフォームファミリー別のドライブ交換手順
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
プラットフォームまたはシェルフ ファミリ別に整理されたNetAppストレージ システムのドライブ交換手順を見つけます。このリファレンスには、 AFF、 ASA、 FAS、およびシェルフ システムのドライブ交換ワークフローの手順への直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。
...
* link:../c80/drive-replace.html["AFF C80用"]
...
* link:../sas3/service-replace-drawer-ds460c.html["DS460C ドロワー"]
