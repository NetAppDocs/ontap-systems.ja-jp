...
summary: プラットフォーム ファミリ別に整理されたNetAppストレージ システムの電源交換手順を見つけます。このリファレンスには、 AFF、 ASA、およびFASシステムの電源装置交換の手順ごとのワークフローへの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。 
---
= プラットフォームファミリー別の電源交換手順
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
プラットフォーム ファミリ別に整理されたNetAppストレージ システムの電源交換手順を見つけます。このリファレンスには、 AFF、 ASA、およびFASシステムの電源装置交換の手順ごとのワークフローへの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。
...
* link:../a1k/power-supply-replace.html["AFF A1K用"]
...
* link:../c80/power-supply-replace.html["AFF C80用"]
