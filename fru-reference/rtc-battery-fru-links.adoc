...
summary: プラットフォーム ファミリ別に整理された、 NetAppストレージ システムの RTC バッテリ交換手順を確認します。このリファレンスには、 AFF、 ASA、およびFASシステムの RTC バッテリ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。 
---
= プラットフォームファミリー別のRTCバッテリー交換手順
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
プラットフォーム ファミリ別に整理された、 NetAppストレージ システムの RTC バッテリ交換手順を確認します。このリファレンスには、 AFF、 ASA、およびFASシステムの RTC バッテリ交換ワークフローのステップバイステップの直接リンクが用意されており、特定のモデルに適した手順をすぐに見つけることができます。
...
* link:../a1k/rtc-battery-replace.html["AFF A1K用"]
...
* link:../c80/rtc-battery-replace.html["AFF C80用"]
