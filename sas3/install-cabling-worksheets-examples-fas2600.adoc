...
---
= 内部ストレージプラットフォームを備えたDS212C、DS224C、またはDS460Cシェルフ用のケーブル配線ワークシート
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
完成したコントローラーとスタック間のケーブル配線ワークシートとケーブル配線例を使用して、内部ストレージを備えたプラットフォームにケーブルを配線できます。これは、IOM12、IOM12B、またはIOM12Cモジュールを搭載したシェルフに適用されます。
...
NOTE: このセクションは FAS2820 システムには適用されません。
