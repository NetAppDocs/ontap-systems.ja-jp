...
summary: コントローラーとスタック間のケーブル配線に関するワークシートと例を使用すると、HAペアをマルチパスHA構成として配線できます。 
---
= DS212C、DS224C、またはDS460CマルチパスHA構成用のケーブル配線ワークシート
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
これは、IOM12、IOM12B、またはIOM12Cモジュールを搭載したシェルフに適用されます。
